 ...
 * limitations under the License.
 */
function(){if("undefined"!=typeof self)return self;if("undefined"!=typeof window)return window;if(void 0!==t)return t;throw new Error("Unable to locate global object.")}().__FIREBASE_DEFAULTS__,V=()=>{try{return U()||(()=>{if(void 0===w||void 0===w.env)return})()||(()=>{if("undefined"==typeof document)return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch(e){return}const t=e&&F(e[1]);return t&&JSON.parse(t)})()}catch(e){return void console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`)}},j=e=>{var t,n;return null===(n=null===(t=V())||void 0===t?void 0:t.emulatorHosts)||void 0===n?void 0:n[e]},q=e=>{const t=j(e);if(!t)return;const n=t.lastIndexOf(":");if(n<=0||n+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);const i=parseInt(t.substring(n+1),10);return"["===t[0]?[t.substring(1,n-1),i]:[t.substring(0,n),i]},B=()=>{var e;return null===(e=V())||void 0===e?void 0:e.config},H=e=>{var t;return null===(t=V())||void 0===t?void 0:t[`_${e}`]};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Fe{getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}constructor(e){this.container=e}}const Ue=new ve("@firebase/app"),Ve={"@firebase/app":"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},je=new Map,qe=new Map;function Be(e,t){try{e.container.addComponent(t)}catch(n){Ue.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function He(e){const t=e.name;if(qe.has(t))return Ue.debug(`There were multiple attempts to register component ${t}.`),!1;qe.set(t,e);for(const t of je.values())Be(t,e);return!0}function ze(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function We(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const i=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),s=i.name;if("string"!=typeof s||!s)throw $e.create("bad-app-name",{appName:String(s)});if(n||(n=B()),!n)throw $e.create("no-options");const r=je.get(s);if(r){if(ee(n,r.options)&&ee(i,r.config))return r;throw $e.create("duplicate-app",{appName:s})}const o=new ue(s);for(const e of qe.values())o.addComponent(e);const a=new Ke(n,i,o);return je.set(s,a),a}function Ge(e="[DEFAULT]"){const t=je.get(e);if(!t&&"[DEFAULT]"===e&&B())return We();if(!t)throw $e.create("no-app",{appName:e});return t}function Qe(e,t,n){var i;let s=null!==(i=Ve[e])&&void 0!==i?i:e;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const e=[`Unable to register library "${s}" with version "${t}":`];return r&&e.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Ue.warn(e.join(" "))}He(new ce(`${s}-version`,(()=>({library:s,version:t})),"VERSION"))}let Je=null;function Ye(){return Je||(Je=xe("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw $e.create("idb-open",{originalErrorMessage:e.message})}))),Je}async function Xe(e,t){try{const n=(await Ye()).transaction("firebase-heartbeat-store","readwrite"),i=n.objectStore("firebase-heartbeat-store");await i.put(t,Ze(e)),await n.done}catch(e){if(e instanceof J)Ue.warn(e.message);else{const t=$e.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});Ue.warn(t.message)}}}function Ze(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class et{async triggerHeartbeat(){const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),t=tt();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==t&&!this._heartbeatsCache.heartbeats.some((e=>e.date===t)))return this._heartbeatsCache.heartbeats.push({date:t,agent:e}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((e=>{const t=new Date(e.date).valueOf();return Date.now()-t<=2592e6})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const e=tt(),{heartbeatsToSend:t,unsentEntries:n}=function(e,t=1024){const n=[];let i=e.slice();for(const s of e){const e=n.find((e=>e.agent===s.agent));if(e){if(e.dates.push(s.date),it(n)>t){e.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),it(n)>t){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}(this._heartbeatsCache.heartbeats),i=M(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new nt(t),this._heartbeatsCachePromise=this._storage.read().then((e=>(this._heartbeatsCache=e,e)))}}function tt(){return(new Date).toISOString().substring(0,10)}class nt{async runIndexedDBEnvironmentCheck(){return!!Q()&&new Promise(((e,t)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(i),e(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var e;t((null===(e=s.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}})).then((()=>!0)).catch((()=>!1))}async read(){if(await this._canUseIndexedDBPromise){return await async function(e){try{const t=await Ye();return await t.transaction("firebase-heartbeat-store").objectStore("firebase-heartbeat-store").get(Ze(e))}catch(e){if(e instanceof J)Ue.warn(e.message);else{const t=$e.create("idb-get",{originalErrorMessage:null==e?void 0:e.message});Ue.warn(t.message)}}}(this.app)||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Xe(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Xe(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}}constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}}function it(e){return M(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
Qe("firebase","9.22.0","app");var rt,ot="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==t?t:"undefined"!=typeof self?self:{},at={},ht=ht||{},ct=ot||self;function lt(){}function ut(e){var t=typeof e;return"array"==(t="object"!=t?t:e?Array.isArray(e)?"array":t:"null")||"object"==t&&"number"==typeof e.length}function dt(e){var t=typeof e;return"object"==t&&null!=e||"function"==t}var ft="closure_uid_"+(1e9*Math.random()>>>0),pt=0;function mt(e,t,n){return e.call.apply(e.bind,arguments)}function gt(e,t,n){if(!e)throw Error();if(2<arguments.length){var i=Array.prototype.slice.call(arguments,2);return function(){var n=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(n,i),e.apply(t,n)}}return function(){return e.apply(t,arguments)}}function yt(e,t,n){return(yt=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?mt:gt).apply(null,arguments)}function wt(e,t){var n=Array.prototype.slice.call(arguments,1);return function(){var t=n.slice();return t.push.apply(t,arguments),e.apply(this,t)}}function vt(e,t){function n(){}n.prototype=t.prototype,e.$=t.prototype,e.prototype=new n,e.prototype.constructor=e,e.ac=function(e,n,i){for(var s=Array(arguments.length-2),r=2;r<arguments.length;r++)s[r-2]=arguments[r];return t.prototype[n].apply(e,s)}}function bt(){this.s=this.s,this.o=this.o}bt.prototype.s=!1,bt.prototype.ra=function(){var e;!this.s&&(this.s=!0,this.N(),0)&&(e=this,Object.prototype.hasOwnProperty.call(e,ft)&&e[ft]||(e[ft]=++pt))},bt.prototype.N=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const _t=Array.prototype.indexOf?function(e,t){return Array.prototype.indexOf.call(e,t,void 0)}:function(e,t){if("string"==typeof e)return"string"!=typeof t||1!=t.length?-1:e.indexOf(t,0);for(let n=0;n<e.length;n++)if(n in e&&e[n]===t)return n;return-1};function Tt(e){const t=e.length;if(0<t){const n=Array(t);for(let i=0;i<t;i++)n[i]=e[i];return n}return[]}function It(e,t){for(let t=1;t<arguments.length;t++){const n=arguments[t];if(ut(n)){const t=e.length||0,i=n.length||0;e.length=t+i;for(let s=0;s<i;s++)e[t+s]=n[s]}else e.push(n)}}function Et(e,t){this.type=e,this.g=this.target=t,this.defaultPrevented=!1}Et.prototype.h=function(){this.defaultPrevented=!0};var St=function(){if(!ct.addEventListener||!Object.defineProperty)return!1;var e=!1,t=Object.defineProperty({},"passive",{get:function(){e=!0}});try{ct.addEventListener("test",lt,t),ct.removeEventListener("test",lt,t)}catch(e){}return e}();function kt(e){return/^[\s\xa0]*$/.test(e)}var Ct=String.prototype.trim?function(e){return e.trim()}:function(e){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(e)[1]};function At(e,t){return e<t?-1:e>t?1:0}function Nt(){var e=ct.navigator;return e&&(e=e.userAgent)?e:""}function Dt(e){return-1!=Nt().indexOf(e)}function Rt(e){return Rt[" "](e),e}function xt(e,t,n){return Object.prototype.hasOwnProperty.call(e,t)?e[t]:e[t]=n(t)}Rt[" "]=lt;var Ot,Lt,Pt=Dt("Opera"),Mt=Dt("Trident")||Dt("MSIE"),Ft=Dt("Edge"),Ut=Ft||Mt,Vt=Dt("Gecko")&&!(-1!=Nt().toLowerCase().indexOf("webkit")&&!Dt("Edge"))&&!(Dt("Trident")||Dt("MSIE"))&&!Dt("Edge"),jt=-1!=Nt().toLowerCase().indexOf("webkit")&&!Dt("Edge");function qt(){var e=ct.document;return e?e.documentMode:void 0}e:{var Bt="",Ht=(Lt=Nt(),Vt?/rv:([^\);]+)(\)|;)/.exec(Lt):Ft?/Edge\/([\d\.]+)/.exec(Lt):Mt?/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(Lt):jt?/WebKit\/(\S+)/.exec(Lt):Pt?/(?:Version)[ \/]?(\S+)/.exec(Lt):void 0);if(Ht&&(Bt=Ht?Ht[1]:""),Mt){var zt=qt();if(null!=zt&&zt>parseFloat(Bt)){Ot=String(zt);break e}}Ot=Bt}var $t,Kt={};if(ct.document&&Mt){var Wt=qt();$t=Wt||(parseInt(Ot,10)||void 0)}else $t=void 0;var Gt=$t;function Qt(e,t){if(Et.call(this,e?e.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,e){var n=this.type=e.type,i=e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null;if(this.target=e.target||e.srcElement,this.g=t,t=e.relatedTarget){if(Vt){e:{try{Rt(t.nodeName);var s=!0;break e}catch(e){}s=!1}s||(t=null)}}else"mouseover"==n?t=e.fromElement:"mouseout"==n&&(t=e.toElement);this.relatedTarget=t,i?(this.clientX=void 0!==i.clientX?i.clientX:i.pageX,this.clientY=void 0!==i.clientY?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0):(this.clientX=void 0!==e.clientX?e.clientX:e.pageX,this.clientY=void 0!==e.clientY?e.clientY:e.pageY,this.screenX=e.screenX||0,this.screenY=e.screenY||0),this.button=e.button,this.key=e.key||"",this.ctrlKey=e.ctrlKey,this.altKey=e.altKey,this.shiftKey=e.shiftKey,this.metaKey=e.metaKey,this.pointerId=e.pointerId||0,this.pointerType="string"==typeof e.pointerType?e.pointerType:Jt[e.pointerType]||"",this.state=e.state,this.i=e,e.defaultPrevented&&Qt.$.h.call(this)}}vt(Qt,Et);var Jt={2:"touch",3:"pen",4:"mouse"};Qt.prototype.h=function(){Qt.$.h.call(this);var e=this.i;e.preventDefault?e.preventDefault():e.returnValue=!1};var Yt="closure_listenable_"+(1e6*Math.random()|0),Xt=0;function Zt(e,t,n,i,s){this.listener=e,this.proxy=null,this.src=t,this.type=n,this.capture=!!i,this.la=s,this.key=++Xt,this.fa=this.ia=!1}function en(e){e.fa=!0,e.listener=null,e.proxy=null,e.src=null,e.la=null}function tn(e,t,n){for(const i in e)t.call(n,e[i],i,e)}function nn(e){const t={};for(const n in e)t[n]=e[n];return t}const sn="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function rn(e,t){let n,i;for(let t=1;t<arguments.length;t++){for(n in i=arguments[t],i)e[n]=i[n];for(let t=0;t<sn.length;t++)n=sn[t],Object.prototype.hasOwnProperty.call(i,n)&&(e[n]=i[n])}}function on(e){this.src=e,this.g={},this.h=0}function an(e,t){var n=t.type;if(n in e.g){var i,s=e.g[n],r=_t(s,t);(i=0<=r)&&Array.prototype.splice.call(s,r,1),i&&(en(t),0==e.g[n].length&&(delete e.g[n],e.h--))}}function hn(e,t,n,i){for(var s=0;s<e.length;++s){var r=e[s];if(!r.fa&&r.listener==t&&r.capture==!!n&&r.la==i)return s}return-1}on.prototype.add=function(e,t,n,i,s){var r=e.toString();(e=this.g[r])||(e=this.g[r]=[],this.h++);var o=hn(e,t,i,s);return-1<o?(t=e[o],n||(t.ia=!1)):((t=new Zt(t,this.src,r,!!i,s)).ia=n,e.push(t)),t};var cn="closure_lm_"+(1e6*Math.random()|0),ln={};function un(e,t,n,i,s){if(i&&i.once)return fn(e,t,n,i,s);if(Array.isArray(t)){for(var r=0;r<t.length;r++)un(e,t[r],n,i,s);return null}return n=bn(n),e&&e[Yt]?e.O(t,n,dt(i)?!!i.capture:!!i,s):dn(e,t,n,!1,i,s)}function dn(e,t,n,i,s,r){if(!t)throw Error("Invalid event type");var o=dt(s)?!!s.capture:!!s,a=wn(e);if(a||(e[cn]=a=new on(e)),(n=a.add(t,n,i,o,r)).proxy)return n;if(i=function(){function e(n){return t.call(e.src,e.listener,n)}const t=yn;return e}(),n.proxy=i,i.src=e,i.listener=n,e.addEventListener)St||(s=o),void 0===s&&(s=!1),e.addEventListener(t.toString(),i,s);else if(e.attachEvent)e.attachEvent(gn(t.toString()),i);else{if(!e.addListener||!e.removeListener)throw Error("addEventListener and attachEvent are unavailable.");e.addListener(i)}return n}function fn(e,t,n,i,s){if(Array.isArray(t)){for(var r=0;r<t.length;r++)fn(e,t[r],n,i,s);return null}return n=bn(n),e&&e[Yt]?e.P(t,n,dt(i)?!!i.capture:!!i,s):dn(e,t,n,!0,i,s)}function pn(e,t,n,i,s){if(Array.isArray(t))for(var r=0;r<t.length;r++)pn(e,t[r],n,i,s);else i=dt(i)?!!i.capture:!!i,n=bn(n),e&&e[Yt]?(e=e.i,(t=String(t).toString())in e.g&&(-1<(n=hn(r=e.g[t],n,i,s))&&(en(r[n]),Array.prototype.splice.call(r,n,1),0==r.length&&(delete e.g[t],e.h--)))):e&&(e=wn(e))&&(t=e.g[t.toString()],e=-1,t&&(e=hn(t,n,i,s)),(n=-1<e?t[e]:null)&&mn(n))}function mn(e){if("number"!=typeof e&&e&&!e.fa){var t=e.src;if(t&&t[Yt])an(t.i,e);else{var n=e.type,i=e.proxy;t.removeEventListener?t.removeEventListener(n,i,e.capture):t.detachEvent?t.detachEvent(gn(n),i):t.addListener&&t.removeListener&&t.removeListener(i),(n=wn(t))?(an(n,e),0==n.h&&(n.src=null,t[cn]=null)):en(e)}}}function gn(e){return e in ln?ln[e]:ln[e]="on"+e}function yn(e,t){if(e.fa)e=!0;else{t=new Qt(t,this);var n=e.listener,i=e.la||e.src;e.ia&&mn(e),e=n.call(i,t)}return e}function wn(e){return(e=e[cn])instanceof on?e:null}var vn="__closure_events_fn_"+(1e9*Math.random()>>>0);function bn(e){return"function"==typeof e?e:(e[vn]||(e[vn]=function(t){return e.handleEvent(t)}),e[vn])}function _n(){bt.call(this),this.i=new on(this),this.S=this,this.J=null}function Tn(e,t){var n,i=e.J;if(i)for(n=[];i;i=i.J)n.push(i);if(e=e.S,i=t.type||t,"string"==typeof t)t=new Et(t,e);else if(t instanceof Et)t.target=t.target||e;else{var s=t;rn(t=new Et(i,e),s)}if(s=!0,n)for(var r=n.length-1;0<=r;r--){var o=t.g=n[r];s=In(o,i,!0,t)&&s}if(s=In(o=t.g=e,i,!0,t)&&s,s=In(o,i,!1,t)&&s,n)for(r=0;r<n.length;r++)s=In(o=t.g=n[r],i,!1,t)&&s}function In(e,t,n,i){if(!(t=e.i.g[String(t)]))return!0;t=t.concat();for(var s=!0,r=0;r<t.length;++r){var o=t[r];if(o&&!o.fa&&o.capture==n){var a=o.listener,h=o.la||o.src;o.ia&&an(e.i,o),s=!1!==a.call(h,i)&&s}}return s&&!i.defaultPrevented}vt(_n,bt),_n.prototype[Yt]=!0,_n.prototype.removeEventListener=function(e,t,n,i){pn(this,e,t,n,i)},_n.prototype.N=function(){if(_n.$.N.call(this),this.i){var e,t=this.i;for(e in t.g){for(var n=t.g[e],i=0;i<n.length;i++)en(n[i]);delete t.g[e],t.h--}}this.J=null},_n.prototype.O=function(e,t,n,i){return this.i.add(String(e),t,!1,n,i)},_n.prototype.P=function(e,t,n,i){return this.i.add(String(e),t,!0,n,i)};var En=ct.JSON.stringify;function Sn(){var e=xn;let t=null;return e.g&&(t=e.g,e.g=e.g.next,e.g||(e.h=null),t.next=null),t}var kn,Cn=new class{get(){let e;return 0<this.h?(this.h--,e=this.g,this.g=e.next,e.next=null):e=this.i(),e}constructor(e,t){this.i=e,this.j=t,this.h=0,this.g=null}}((()=>new An),(e=>e.reset()));class An{set(e,t){this.h=e,this.g=t,this.next=null}reset(){this.next=this.g=this.h=null}constructor(){this.next=this.g=this.h=null}}function Nn(e){ct.setTimeout((()=>{throw e}),0)}function Dn(e,t){kn||function(){var e=ct.Promise.resolve(void 0);kn=function(){e.then(On)}}(),Rn||(kn(),Rn=!0),xn.add(e,t)}var Rn=!1,xn=new class{add(e,t){const n=Cn.get();n.set(e,t),this.h?this.h.next=n:this.g=n,this.h=n}constructor(){this.h=this.g=null}};function On(){for(var e;e=Sn();){try{e.h.call(e.g)}catch(e){Nn(e)}var t=Cn;t.j(e),100>t.h&&(t.h++,e.next=t.g,t.g=e)}Rn=!1}function Ln(e,t){_n.call(this),this.h=e||1,this.g=t||ct,this.j=yt(this.qb,this),this.l=Date.now()}function Pn(e){e.ga=!1,e.T&&(e.g.clearTimeout(e.T),e.T=null)}function Mn(e,t,n){if("function"==typeof e)n&&(e=yt(e,n));else{if(!e||"function"!=typeof e.handleEvent)throw Error("Invalid listener argument");e=yt(e.handleEvent,e)}return 2147483647<Number(t)?-1:ct.setTimeout(e,t||0)}function Fn(e){e.g=Mn((()=>{e.g=null,e.i&&(e.i=!1,Fn(e))}),e.j);const t=e.h;e.h=null,e.m.apply(null,t)}vt(Ln,_n),(rt=Ln.prototype).ga=!1,rt.T=null,rt.qb=function(){if(this.ga){var e=Date.now()-this.l;0<e&&e<.8*this.h?this.T=this.g.setTimeout(this.j,this.h-e):(this.T&&(this.g.clearTimeout(this.T),this.T=null),Tn(this,"tick"),this.ga&&(Pn(this),this.start()))}},rt.start=function(){this.ga=!0,this.T||(this.T=this.g.setTimeout(this.j,this.h),this.l=Date.now())},rt.N=function(){Ln.$.N.call(this),Pn(this),delete this.g};class Un extends bt{l(e){this.h=arguments,this.g?this.i=!0:Fn(this)}N(){super.N(),this.g&&(ct.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}constructor(e,t){super(),this.m=e,this.j=t,this.h=null,this.i=!1,this.g=null}}function Vn(e){bt.call(this),this.h=e,this.g={}}vt(Vn,bt);var jn=[];function qn(e,t,n,i){Array.isArray(n)||(n&&(jn[0]=n.toString()),n=jn);for(var s=0;s<n.length;s++){var r=un(t,n[s],i||e.handleEvent,!1,e.h||e);if(!r)break;e.g[r.key]=r}}function Bn(e){tn(e.g,(function(e,t){this.g.hasOwnProperty(t)&&mn(e)}),e),e.g={}}function Hn(){this.g=!0}function zn(e,t,n,i){e.info((function(){return"XMLHTTP TEXT ("+t+"): "+function(e,t){if(!e.g)return t;if(!t)return null;try{var n=JSON.parse(t);if(n)for(e=0;e<n.length;e++)if(Array.isArray(n[e])){var i=n[e];if(!(2>i.length)){var s=i[1];if(Array.isArray(s)&&!(1>s.length)){var r=s[0];if("noop"!=r&&"stop"!=r&&"close"!=r)for(var o=1;o<s.length;o++)s[o]=""}}}return En(n)}catch(e){return t}}(e,n)+(i?" "+i:"")}))}Vn.prototype.N=function(){Vn.$.N.call(this),Bn(this)},Vn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")},Hn.prototype.Ea=function(){this.g=!1},Hn.prototype.info=function(){};var $n={},Kn=null;function Wn(){return Kn=Kn||new _n}function Gn(e){Et.call(this,$n.Ta,e)}function Qn(e){const t=Wn();Tn(t,new Gn(t))}function Jn(e,t){Et.call(this,$n.STAT_EVENT,e),this.stat=t}function Yn(e){const t=Wn();Tn(t,new Jn(t,e))}function Xn(e,t){Et.call(this,$n.Ua,e),this.size=t}function Zn(e,t){if("function"!=typeof e)throw Error("Fn must not be null and must be a function");return ct.setTimeout((function(){e()}),t)}$n.Ta="serverreachability",vt(Gn,Et),$n.STAT_EVENT="statevent",vt(Jn,Et),$n.Ua="timingevent",vt(Xn,Et);var ei={NO_ERROR:0,rb:1,Eb:2,Db:3,yb:4,Cb:5,Fb:6,Qa:7,TIMEOUT:8,Ib:9},ti={wb:"complete",Sb:"success",Ra:"error",Qa:"abort",Kb:"ready",Lb:"readystatechange",TIMEOUT:"timeout",Gb:"incrementaldata",Jb:"progress",zb:"downloadprogress",$b:"uploadprogress"};function ni(){}function ii(e){return e.h||(e.h=e.i())}function si(){}ni.prototype.h=null;var ri,oi={OPEN:"a",vb:"b",Ra:"c",Hb:"d"};function ai(){Et.call(this,"d")}function hi(){Et.call(this,"c")}function ci(){}function li(e,t,n,i){this.l=e,this.j=t,this.m=n,this.W=i||1,this.U=new Vn(this),this.P=di,e=Ut?125:void 0,this.V=new Ln(e),this.I=null,this.i=!1,this.s=this.A=this.v=this.L=this.G=this.Y=this.B=null,this.F=[],this.g=null,this.C=0,this.o=this.u=null,this.aa=-1,this.J=!1,this.O=0,this.M=null,this.ca=this.K=this.ba=this.S=!1,this.h=new ui}function ui(){this.i=null,this.g="",this.h=!1}vt(ai,Et),vt(hi,Et),vt(ci,ni),ci.prototype.g=function(){return new XMLHttpRequest},ci.prototype.i=function(){return{}},ri=new ci;var di=45e3,fi={},pi={};function mi(e,t,n){e.L=1,e.v=Li(Ni(t)),e.s=n,e.S=!0,gi(e,null)}function gi(e,t){e.G=Date.now(),bi(e),e.A=Ni(e.v);var n=e.A,i=e.W;Array.isArray(i)||(i=[String(i)]),Wi(n.i,"t",i),e.C=0,n=e.l.I,e.h=new ui,e.g=Ks(e.l,n?t:null,!e.s),0<e.O&&(e.M=new Un(yt(e.Pa,e,e.g),e.O)),qn(e.U,e.g,"readystatechange",e.nb),t=e.I?nn(e.I):{},e.s?(e.u||(e.u="POST"),t["Content-Type"]="application/x-www-form-urlencoded",e.g.ha(e.A,e.u,e.s,t)):(e.u="GET",e.g.ha(e.A,e.u,null,t)),Qn(),function(e,t,n,i,s,r){e.info((function(){if(e.g)if(r)for(var o="",a=r.split("&"),h=0;h<a.length;h++){var c=a[h].split("=");if(1<c.length){var l=c[0];c=c[1];var u=l.split("_");o=2<=u.length&&"type"==u[1]?o+(l+"=")+c+"&":o+(l+"=redacted&")}}else o=null;else o=r;return"XMLHTTP REQ ("+i+") [attempt "+s+"]: "+t+"\n"+n+"\n"+o}))}(e.j,e.u,e.A,e.m,e.W,e.s)}function yi(e){return!!e.g&&("GET"==e.u&&2!=e.L&&e.l.Ha)}function wi(e,t,n){let i,s=!0;for(;!e.J&&e.C<n.length;){if(i=vi(e,n),i==pi){4==t&&(e.o=4,Yn(14),s=!1),zn(e.j,e.m,null,"[Incomplete Response]");break}if(i==fi){e.o=4,Yn(15),zn(e.j,e.m,n,"[Invalid Chunk]"),s=!1;break}zn(e.j,e.m,i,null),Si(e,i)}yi(e)&&i!=pi&&i!=fi&&(e.h.g="",e.C=0),4!=t||0!=n.length||e.h.h||(e.o=1,Yn(16),s=!1),e.i=e.i&&s,s?0<n.length&&!e.ca&&(e.ca=!0,(t=e.l).g==e&&t.ca&&!t.L&&(t.j.info("Great, no buffering proxy detected. Bytes received: "+n.length),Us(t),t.L=!0,Yn(11))):(zn(e.j,e.m,n,"[Invalid Chunked Response]"),Ei(e),Ii(e))}function vi(e,t){var n=e.C,i=t.indexOf("\n",n);return-1==i?pi:(n=Number(t.substring(n,i)),isNaN(n)?fi:(i+=1)+n>t.length?pi:(t=t.substr(i,n),e.C=i+n,t))}function bi(e){e.Y=Date.now()+e.P,_i(e,e.P)}function _i(e,t){if(null!=e.B)throw Error("WatchDog timer not null");e.B=Zn(yt(e.lb,e),t)}function Ti(e){e.B&&(ct.clearTimeout(e.B),e.B=null)}function Ii(e){0==e.l.H||e.J||qs(e.l,e)}function Ei(e){Ti(e);var t=e.M;t&&"function"==typeof t.ra&&t.ra(),e.M=null,Pn(e.V),Bn(e.U),e.g&&(t=e.g,e.g=null,t.abort(),t.ra())}function Si(e,t){try{var n=e.l;if(0!=n.H&&(n.g==e||Zi(n.h,e)))if(!e.K&&Zi(n.h,e)&&3==n.H){try{var i=n.Ja.g.parse(t)}catch(e){i=null}if(Array.isArray(i)&&3==i.length){var s=i;if(0==s[0]){e:if(!n.u){if(n.g){if(!(n.g.G+3e3<e.G))break e;js(n),Ds(n)}Fs(n),Yn(18)}}else n.Fa=s[1],0<n.Fa-n.V&&37500>s[2]&&n.M&&0==n.A&&!n.v&&(n.v=Zn(yt(n.ib,n),6e3));if(1>=Xi(n.h)&&n.na){try{n.na()}catch(e){}n.na=void 0}}else Hs(n,11)}else if((e.K||n.g==e)&&js(n),!kt(t))for(s=n.Ja.g.parse(t),t=0;t<s.length;t++){let c=s[t];if(n.V=c[0],c=c[1],2==n.H)if("c"==c[0]){n.J=c[1],n.oa=c[2];const t=c[3];null!=t&&(n.qa=t,n.j.info("VER="+n.qa));const s=c[4];null!=s&&(n.Ga=s,n.j.info("SVER="+n.Ga));const l=c[5];null!=l&&"number"==typeof l&&0<l&&(i=1.5*l,n.K=i,n.j.info("backChannelRequestTimeoutMs_="+i)),i=n;const u=e.g;if(u){const e=u.g?u.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(e){var r=i.h;r.g||-1==e.indexOf("spdy")&&-1==e.indexOf("quic")&&-1==e.indexOf("h2")||(r.j=r.l,r.g=new Set,r.h&&(es(r,r.h),r.h=null))}if(i.F){const e=u.g?u.g.getResponseHeader("X-HTTP-Session-Id"):null;e&&(i.Da=e,Oi(i.G,i.F,e))}}n.H=3,n.l&&n.l.Ba(),n.ca&&(n.S=Date.now()-e.G,n.j.info("Handshake RTT: "+n.S+"ms"));var o=e;if((i=n).wa=$s(i,i.I?i.oa:null,i.Y),o.K){ts(i.h,o);var a=o,h=i.K;h&&a.setTimeout(h),a.B&&(Ti(a),bi(a)),i.g=o}else Ms(i);0<n.i.length&&xs(n)}else"stop"!=c[0]&&"close"!=c[0]||Hs(n,7);else 3==n.H&&("stop"==c[0]||"close"==c[0]?"stop"==c[0]?Hs(n,7):Ns(n):"noop"!=c[0]&&n.l&&n.l.Aa(c),n.A=0)}Qn()}catch(e){}}function ki(e,t){if(e.forEach&&"function"==typeof e.forEach)e.forEach(t,void 0);else if(ut(e)||"string"==typeof e)Array.prototype.forEach.call(e,t,void 0);else for(var n=function(e){if(e.sa&&"function"==typeof e.sa)return e.sa();if(!e.Z||"function"!=typeof e.Z){if("undefined"!=typeof Map&&e instanceof Map)return Array.from(e.keys());if(!("undefined"!=typeof Set&&e instanceof Set)){if(ut(e)||"string"==typeof e){var t=[];e=e.length;for(var n=0;n<e;n++)t.push(n);return t}t=[],n=0;for(const i in e)t[n++]=i;return t}}}(e),i=function(e){if(e.Z&&"function"==typeof e.Z)return e.Z();if("undefined"!=typeof Map&&e instanceof Map||"undefined"!=typeof Set&&e instanceof Set)return Array.from(e.values());if("string"==typeof e)return e.split("");if(ut(e)){for(var t=[],n=e.length,i=0;i<n;i++)t.push(e[i]);return t}for(i in t=[],n=0,e)t[n++]=e[i];return t}(e),s=i.length,r=0;r<s;r++)t.call(void 0,i[r],n&&n[r],e)}(rt=li.prototype).setTimeout=function(e){this.P=e},rt.nb=function(e){e=e.target;const t=this.M;t&&3==Is(e)?t.l():this.Pa(e)},rt.Pa=function(e){try{if(e==this.g)e:{const l=Is(this.g);var t=this.g.Ia();this.g.da();if(!(3>l)&&(3!=l||Ut||this.g&&(this.h.h||this.g.ja()||Es(this.g)))){this.J||4!=l||7==t||Qn(),Ti(this);var n=this.g.da();this.aa=n;t:if(yi(this)){var i=Es(this.g);e="";var s=i.length,r=4==Is(this.g);if(!this.h.i){if("undefined"==typeof TextDecoder){Ei(this),Ii(this);var o="";break t}this.h.i=new ct.TextDecoder}for(t=0;t<s;t++)this.h.h=!0,e+=this.h.i.decode(i[t],{stream:r&&t==s-1});i.splice(0,s),this.h.g+=e,this.C=0,o=this.h.g}else o=this.g.ja();if(this.i=200==n,function(e,t,n,i,s,r,o){e.info((function(){return"XMLHTTP RESP ("+i+") [ attempt "+s+"]: "+t+"\n"+n+"\n"+r+" "+o}))}(this.j,this.u,this.A,this.m,this.W,l,n),this.i){if(this.ba&&!this.K){t:{if(this.g){var a,h=this.g;if((a=h.g?h.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!kt(a)){var c=a;break t}}c=null}if(!(n=c)){this.i=!1,this.o=3,Yn(12),Ei(this),Ii(this);break e}zn(this.j,this.m,n,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Si(this,n)}this.S?(wi(this,l,o),Ut&&this.i&&3==l&&(qn(this.U,this.V,"tick",this.mb),this.V.start())):(zn(this.j,this.m,o,null),Si(this,o)),4==l&&Ei(this),this.i&&!this.J&&(4==l?qs(this.l,this):(this.i=!1,bi(this)))}else 400==n&&0<o.indexOf("Unknown SID")?(this.o=3,Yn(12)):(this.o=0,Yn(13)),Ei(this),Ii(this)}}}catch(e){}},rt.mb=function(){if(this.g){var e=Is(this.g),t=this.g.ja();this.C<t.length&&(Ti(this),wi(this,e,t),this.i&&4!=e&&bi(this))}},rt.cancel=function(){this.J=!0,Ei(this)},rt.lb=function(){this.B=null;const e=Date.now();0<=e-this.Y?(function(e,t){e.info((function(){return"TIMEOUT: "+t}))}(this.j,this.A),2!=this.L&&(Qn(),Yn(17)),Ei(this),this.o=2,Ii(this)):_i(this,this.Y-e)};var Ci=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Ai(e,t){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,e instanceof Ai){this.h=void 0!==t?t:e.h,Di(this,e.j),this.s=e.s,this.g=e.g,Ri(this,e.m),this.l=e.l,t=e.i;var n=new Hi;n.i=t.i,t.g&&(n.g=new Map(t.g),n.h=t.h),xi(this,n),this.o=e.o}else e&&(n=String(e).match(Ci))?(this.h=!!t,Di(this,n[1]||"",!0),this.s=Pi(n[2]||""),this.g=Pi(n[3]||"",!0),Ri(this,n[4]),this.l=Pi(n[5]||"",!0),xi(this,n[6]||"",!0),this.o=Pi(n[7]||"")):(this.h=!!t,this.i=new Hi(null,this.h))}function Ni(e){return new Ai(e)}function Di(e,t,n){e.j=n?Pi(t,!0):t,e.j&&(e.j=e.j.replace(/:$/,""))}function Ri(e,t){if(t){if(t=Number(t),isNaN(t)||0>t)throw Error("Bad port number "+t);e.m=t}else e.m=null}function xi(e,t,n){t instanceof Hi?(e.i=t,function(e,t){t&&!e.j&&(zi(e),e.i=null,e.g.forEach((function(e,t){var n=t.toLowerCase();t!=n&&($i(this,t),Wi(this,n,e))}),e)),e.j=t}(e.i,e.h)):(n||(t=Mi(t,qi)),e.i=new Hi(t,e.h))}function Oi(e,t,n){e.i.set(t,n)}function Li(e){return Oi(e,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),e}function Pi(e,t){return e?t?decodeURI(e.replace(/%25/g,"%2525")):decodeURIComponent(e):""}function Mi(e,t,n){return"string"==typeof e?(e=encodeURI(e).replace(t,Fi),n&&(e=e.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),e):null}function Fi(e){return"%"+((e=e.charCodeAt(0))>>4&15).toString(16)+(15&e).toString(16)}Ai.prototype.toString=function(){var e=[],t=this.j;t&&e.push(Mi(t,Ui,!0),":");var n=this.g;return(n||"file"==t)&&(e.push("//"),(t=this.s)&&e.push(Mi(t,Ui,!0),"@"),e.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),null!=(n=this.m)&&e.push(":",String(n))),(n=this.l)&&(this.g&&"/"!=n.charAt(0)&&e.push("/"),e.push(Mi(n,"/"==n.charAt(0)?ji:Vi,!0))),(n=this.i.toString())&&e.push("?",n),(n=this.o)&&e.push("#",Mi(n,Bi)),e.join("")};var Ui=/[#\/\?@]/g,Vi=/[#\?:]/g,ji=/[#\?]/g,qi=/[#\?@]/g,Bi=/#/g;function Hi(e,t){this.h=this.g=null,this.i=e||null,this.j=!!t}function zi(e){e.g||(e.g=new Map,e.h=0,e.i&&function(e,t){if(e){e=e.split("&");for(var n=0;n<e.length;n++){var i=e[n].indexOf("="),s=null;if(0<=i){var r=e[n].substring(0,i);s=e[n].substring(i+1)}else r=e[n];t(r,s?decodeURIComponent(s.replace(/\+/g," ")):"")}}}(e.i,(function(t,n){e.add(decodeURIComponent(t.replace(/\+/g," ")),n)})))}function $i(e,t){zi(e),t=Gi(e,t),e.g.has(t)&&(e.i=null,e.h-=e.g.get(t).length,e.g.delete(t))}function Ki(e,t){return zi(e),t=Gi(e,t),e.g.has(t)}function Wi(e,t,n){$i(e,t),0<n.length&&(e.i=null,e.g.set(Gi(e,t),Tt(n)),e.h+=n.length)}function Gi(e,t){return t=String(t),e.j&&(t=t.toLowerCase()),t}(rt=Hi.prototype).add=function(e,t){zi(this),this.i=null,e=Gi(this,e);var n=this.g.get(e);return n||this.g.set(e,n=[]),n.push(t),this.h+=1,this},rt.forEach=function(e,t){zi(this),this.g.forEach((function(n,i){n.forEach((function(n){e.call(t,n,i,this)}),this)}),this)},rt.sa=function(){zi(this);const e=Array.from(this.g.values()),t=Array.from(this.g.keys()),n=[];for(let i=0;i<t.length;i++){const s=e[i];for(let e=0;e<s.length;e++)n.push(t[i])}return n},rt.Z=function(e){zi(this);let t=[];if("string"==typeof e)Ki(this,e)&&(t=t.concat(this.g.get(Gi(this,e))));else{e=Array.from(this.g.values());for(let n=0;n<e.length;n++)t=t.concat(e[n])}return t},rt.set=function(e,t){return zi(this),this.i=null,Ki(this,e=Gi(this,e))&&(this.h-=this.g.get(e).length),this.g.set(e,[t]),this.h+=1,this},rt.get=function(e,t){return e&&0<(e=this.Z(e)).length?String(e[0]):t},rt.toString=function(){if(this.i)return this.i;if(!this.g)return"";const e=[],t=Array.from(this.g.keys());for(var n=0;n<t.length;n++){var i=t[n];const r=encodeURIComponent(String(i)),o=this.Z(i);for(i=0;i<o.length;i++){var s=r;""!==o[i]&&(s+="="+encodeURIComponent(String(o[i]))),e.push(s)}}return this.i=e.join("&")};function Qi(e){this.l=e||Ji,ct.PerformanceNavigationTiming?e=0<(e=ct.performance.getEntriesByType("navigation")).length&&("hq"==e[0].nextHopProtocol||"h2"==e[0].nextHopProtocol):e=!!(ct.g&&ct.g.Ka&&ct.g.Ka()&&ct.g.Ka().ec),this.j=e?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var Ji=10;function Yi(e){return!!e.h||!!e.g&&e.g.size>=e.j}function Xi(e){return e.h?1:e.g?e.g.size:0}function Zi(e,t){return e.h?e.h==t:!!e.g&&e.g.has(t)}function es(e,t){e.g?e.g.add(t):e.h=t}function ts(e,t){e.h&&e.h==t?e.h=null:e.g&&e.g.has(t)&&e.g.delete(t)}function ns(e){if(null!=e.h)return e.i.concat(e.h.F);if(null!=e.g&&0!==e.g.size){let t=e.i;for(const n of e.g.values())t=t.concat(n.F);return t}return Tt(e.i)}function is(){}function ss(){this.g=new is}function rs(e,t,n){const i=n||"";try{ki(e,(function(e,n){let s=e;dt(e)&&(s=En(e)),t.push(i+n+"="+encodeURIComponent(s))}))}catch(e){throw t.push(i+"type="+encodeURIComponent("_badmap")),e}}function os(e,t,n,i,s){try{t.onload=null,t.onerror=null,t.onabort=null,t.ontimeout=null,s(i)}catch(e){}}function as(e){this.l=e.fc||null,this.j=e.ob||!1}function hs(e,t){_n.call(this),this.F=e,this.u=t,this.m=void 0,this.readyState=cs,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}Qi.prototype.cancel=function(){if(this.i=ns(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&0!==this.g.size){for(const e of this.g.values())e.cancel();this.g.clear()}},is.prototype.stringify=function(e){return ct.JSON.stringify(e,void 0)},is.prototype.parse=function(e){return ct.JSON.parse(e,void 0)},vt(as,ni),as.prototype.g=function(){return new hs(this.l,this.j)},as.prototype.i=function(e){return function(){return e}}({}),vt(hs,_n);var cs=0;function ls(e){e.j.read().then(e.Xa.bind(e)).catch(e.ka.bind(e))}function us(e){e.readyState=4,e.l=null,e.j=null,e.A=null,ds(e)}function ds(e){e.onreadystatechange&&e.onreadystatechange.call(e)}(rt=hs.prototype).open=function(e,t){if(this.readyState!=cs)throw this.abort(),Error("Error reopening a connection");this.C=e,this.B=t,this.readyState=1,ds(this)},rt.send=function(e){if(1!=this.readyState)throw this.abort(),Error("need to call open() first. ");this.g=!0;const t={headers:this.v,method:this.C,credentials:this.m,cache:void 0};e&&(t.body=e),(this.F||ct).fetch(new Request(this.B,t)).then(this.$a.bind(this),this.ka.bind(this))},rt.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch((()=>{})),1<=this.readyState&&this.g&&4!=this.readyState&&(this.g=!1,us(this)),this.readyState=cs},rt.$a=function(e){if(this.g&&(this.l=e,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=e.headers,this.readyState=2,ds(this)),this.g&&(this.readyState=3,ds(this),this.g)))if("arraybuffer"===this.responseType)e.arrayBuffer().then(this.Ya.bind(this),this.ka.bind(this));else if(void 0!==ct.ReadableStream&&"body"in e){if(this.j=e.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;ls(this)}else e.text().then(this.Za.bind(this),this.ka.bind(this))},rt.Xa=function(e){if(this.g){if(this.u&&e.value)this.response.push(e.value);else if(!this.u){var t=e.value?e.value:new Uint8Array(0);(t=this.A.decode(t,{stream:!e.done}))&&(this.response=this.responseText+=t)}e.done?us(this):ds(this),3==this.readyState&&ls(this)}},rt.Za=function(e){this.g&&(this.response=this.responseText=e,us(this))},rt.Ya=function(e){this.g&&(this.response=e,us(this))},rt.ka=function(){this.g&&us(this)},rt.setRequestHeader=function(e,t){this.v.append(e,t)},rt.getResponseHeader=function(e){return this.h&&this.h.get(e.toLowerCase())||""},rt.getAllResponseHeaders=function(){if(!this.h)return"";const e=[],t=this.h.entries();for(var n=t.next();!n.done;)n=n.value,e.push(n[0]+": "+n[1]),n=t.next();return e.join("\r\n")},Object.defineProperty(hs.prototype,"withCredentials",{get:function(){return"include"===this.m},set:function(e){this.m=e?"include":"same-origin"}});var fs=ct.JSON.parse;function ps(e){_n.call(this),this.headers=new Map,this.u=e||null,this.h=!1,this.C=this.g=null,this.I="",this.m=0,this.j="",this.l=this.G=this.v=this.F=!1,this.B=0,this.A=null,this.K=ms,this.L=this.M=!1}vt(ps,_n);var ms="",gs=/^https?$/i,ys=["POST","PUT"];function ws(e,t){e.h=!1,e.g&&(e.l=!0,e.g.abort(),e.l=!1),e.j=t,e.m=5,vs(e),_s(e)}function vs(e){e.F||(e.F=!0,Tn(e,"complete"),Tn(e,"error"))}function bs(e){if(e.h&&void 0!==ht&&(!e.C[1]||4!=Is(e)||2!=e.da()))if(e.v&&4==Is(e))Mn(e.La,0,e);else if(Tn(e,"readystatechange"),4==Is(e)){e.h=!1;try{const a=e.da();e:switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var t=!0;break e;default:t=!1}var n;if(!(n=t)){var i;if(i=0===a){var s=String(e.I).match(Ci)[1]||null;if(!s&&ct.self&&ct.self.location){var r=ct.self.location.protocol;s=r.substr(0,r.length-1)}i=!gs.test(s?s.toLowerCase():"")}n=i}if(n)Tn(e,"complete"),Tn(e,"success");else{e.m=6;try{var o=2<Is(e)?e.g.statusText:""}catch(e){o=""}e.j=o+" ["+e.da()+"]",vs(e)}}finally{_s(e)}}}function _s(e,t){if(e.g){Ts(e);const n=e.g,i=e.C[0]?lt:null;e.g=null,e.C=null,t||Tn(e,"ready");try{n.onreadystatechange=i}catch(e){}}}function Ts(e){e.g&&e.L&&(e.g.ontimeout=null),e.A&&(ct.clearTimeout(e.A),e.A=null)}function Is(e){return e.g?e.g.readyState:0}function Es(e){try{if(!e.g)return null;if("response"in e.g)return e.g.response;switch(e.K){case ms:case"text":return e.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in e.g)return e.g.mozResponseArrayBuffer}return null}catch(e){return null}}function Ss(e){let t="";return tn(e,(function(e,n){t+=n,t+=":",t+=e,t+="\r\n"})),t}function ks(e,t,n){e:{for(i in n){var i=!1;break e}i=!0}i||(n=Ss(n),"string"==typeof e?null!=n&&encodeURIComponent(String(n)):Oi(e,t,n))}function Cs(e,t,n){return n&&n.internalChannelParams&&n.internalChannelParams[e]||t}function As(e){this.Ga=0,this.i=[],this.j=new Hn,this.oa=this.wa=this.G=this.Y=this.g=this.Da=this.F=this.ma=this.o=this.U=this.s=null,this.fb=this.W=0,this.cb=Cs("failFast",!1,e),this.M=this.v=this.u=this.m=this.l=null,this.aa=!0,this.ta=this.Fa=this.V=-1,this.ba=this.A=this.C=0,this.ab=Cs("baseRetryDelayMs",5e3,e),this.hb=Cs("retryDelaySeedMs",1e4,e),this.eb=Cs("forwardChannelMaxRetries",2,e),this.xa=Cs("forwardChannelRequestTimeoutMs",2e4,e),this.va=e&&e.xmlHttpFactory||void 0,this.Ha=e&&e.dc||!1,this.K=void 0,this.I=e&&e.supportsCrossDomainXhr||!1,this.J="",this.h=new Qi(e&&e.concurrentRequestLimit),this.Ja=new ss,this.P=e&&e.fastHandshake||!1,this.O=e&&e.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.bb=e&&e.bc||!1,e&&e.Ea&&this.j.Ea(),e&&e.forceLongPolling&&(this.aa=!1),this.ca=!this.P&&this.aa&&e&&e.detectBufferingProxy||!1,this.na=void 0,this.S=0,this.L=!1,this.pa=this.B=null}function Ns(e){if(Rs(e),3==e.H){var t=e.W++,n=Ni(e.G);Oi(n,"SID",e.J),Oi(n,"RID",t),Oi(n,"TYPE","terminate"),Ls(e,n),(t=new li(e,e.j,t,void 0)).L=2,t.v=Li(Ni(n)),n=!1,ct.navigator&&ct.navigator.sendBeacon&&(n=ct.navigator.sendBeacon(t.v.toString(),"")),!n&&ct.Image&&((new Image).src=t.v,n=!0),n||(t.g=Ks(t.l,null),t.g.ha(t.v)),t.G=Date.now(),bi(t)}zs(e)}function Ds(e){e.g&&(Us(e),e.g.cancel(),e.g=null)}function Rs(e){Ds(e),e.u&&(ct.clearTimeout(e.u),e.u=null),js(e),e.h.cancel(),e.m&&("number"==typeof e.m&&ct.clearTimeout(e.m),e.m=null)}function xs(e){Yi(e.h)||e.m||(e.m=!0,Dn(e.Na,e),e.C=0)}function Os(e,t){var n;n=t?t.m:e.W++;const i=Ni(e.G);Oi(i,"SID",e.J),Oi(i,"RID",n),Oi(i,"AID",e.V),Ls(e,i),e.o&&e.s&&ks(i,e.o,e.s),n=new li(e,e.j,n,e.C+1),null===e.o&&(n.I=e.s),t&&(e.i=t.F.concat(e.i)),t=Ps(e,n,1e3),n.setTimeout(Math.round(.5*e.xa)+Math.round(.5*e.xa*Math.random())),es(e.h,n),mi(n,i,t)}function Ls(e,t){e.ma&&tn(e.ma,(function(e,n){Oi(t,n,e)})),e.l&&ki({},(function(e,n){Oi(t,n,e)}))}function Ps(e,t,n){n=Math.min(e.i.length,n);var i=e.l?yt(e.l.Va,e.l,e):null;e:{var s=e.i;let t=-1;for(;;){const e=["count="+n];-1==t?0<n?(t=s[0].h,e.push("ofs="+t)):t=0:e.push("ofs="+t);let r=!0;for(let o=0;o<n;o++){let n=s[o].h;const a=s[o].g;if(n-=t,0>n)t=Math.max(0,s[o].h-100),r=!1;else try{rs(a,e,"req"+n+"_")}catch(e){i&&i(a)}}if(r){i=e.join("&");break e}}}return e=e.i.splice(0,n),t.F=e,i}function Ms(e){e.g||e.u||(e.ba=1,Dn(e.Ma,e),e.A=0)}function Fs(e){return!(e.g||e.u||3<=e.A)&&(e.ba++,e.u=Zn(yt(e.Ma,e),Bs(e,e.A)),e.A++,!0)}function Us(e){null!=e.B&&(ct.clearTimeout(e.B),e.B=null)}function Vs(e){e.g=new li(e,e.j,"rpc",e.ba),null===e.o&&(e.g.I=e.s),e.g.O=0;var t=Ni(e.wa);Oi(t,"RID","rpc"),Oi(t,"SID",e.J),Oi(t,"CI",e.M?"0":"1"),Oi(t,"AID",e.V),Oi(t,"TYPE","xmlhttp"),Ls(e,t),e.o&&e.s&&ks(t,e.o,e.s),e.K&&e.g.setTimeout(e.K);var n=e.g;e=e.oa,n.L=1,n.v=Li(Ni(t)),n.s=null,n.S=!0,gi(n,e)}function js(e){null!=e.v&&(ct.clearTimeout(e.v),e.v=null)}function qs(e,t){var n=null;if(e.g==t){js(e),Us(e),e.g=null;var i=2}else{if(!Zi(e.h,t))return;n=t.F,ts(e.h,t),i=1}if(0!=e.H)if(e.ta=t.aa,t.i)if(1==i){n=t.s?t.s.length:0,t=Date.now()-t.G;var s=e.C;Tn(i=Wn(),new Xn(i,n)),xs(e)}else Ms(e);else if(3==(s=t.o)||0==s&&0<e.ta||!(1==i&&function(e,t){return!(Xi(e.h)>=e.h.j-(e.m?1:0)||(e.m?(e.i=t.F.concat(e.i),0):1==e.H||2==e.H||e.C>=(e.cb?0:e.eb)||(e.m=Zn(yt(e.Na,e,t),Bs(e,e.C)),e.C++,0)))}(e,t)||2==i&&Fs(e)))switch(n&&0<n.length&&(t=e.h,t.i=t.i.concat(n)),s){case 1:Hs(e,5);break;case 4:Hs(e,10);break;case 3:Hs(e,6);break;default:Hs(e,2)}}function Bs(e,t){let n=e.ab+Math.floor(Math.random()*e.hb);return e.l||(n*=2),n*t}function Hs(e,t){if(e.j.info("Error code "+t),2==t){var n=null;e.l&&(n=null);var i=yt(e.pb,e);n||(n=new Ai("//www.google.com/images/cleardot.gif"),ct.location&&"http"==ct.location.protocol||Di(n,"https"),Li(n)),function(e,t){const n=new Hn;if(ct.Image){const i=new Image;i.onload=wt(os,n,i,"TestLoadImage: loaded",!0,t),i.onerror=wt(os,n,i,"TestLoadImage: error",!1,t),i.onabort=wt(os,n,i,"TestLoadImage: abort",!1,t),i.ontimeout=wt(os,n,i,"TestLoadImage: timeout",!1,t),ct.setTimeout((function(){i.ontimeout&&i.ontimeout()}),1e4),i.src=e}else t(!1)}(n.toString(),i)}else Yn(2);e.H=0,e.l&&e.l.za(t),zs(e),Rs(e)}function zs(e){if(e.H=0,e.pa=[],e.l){const t=ns(e.h);0==t.length&&0==e.i.length||(It(e.pa,t),It(e.pa,e.i),e.h.i.length=0,Tt(e.i),e.i.length=0),e.l.ya()}}function $s(e,t,n){var i=n instanceof Ai?Ni(n):new Ai(n,void 0);if(""!=i.g)t&&(i.g=t+"."+i.g),Ri(i,i.m);else{var s=ct.location;i=s.protocol,t=t?t+"."+s.hostname:s.hostname,s=+s.port;var r=new Ai(null,void 0);i&&Di(r,i),t&&(r.g=t),s&&Ri(r,s),n&&(r.l=n),i=r}return n=e.F,t=e.Da,n&&t&&Oi(i,n,t),Oi(i,"VER",e.qa),Ls(e,i),i}function Ks(e,t,n){if(t&&!e.I)throw Error("Can't create secondary domain capable XhrIo object.");return(t=n&&e.Ha&&!e.va?new ps(new as({ob:!0})):new ps(e.va)).Oa(e.I),t}function Ws(){}function Gs(){if(Mt&&!(10<=Number(Gt)))throw Error("Environmental error: no available transport.")}function Qs(e,t){_n.call(this),this.g=new As(t),this.l=e,this.h=t&&t.messageUrlParams||null,e=t&&t.messageHeaders||null,t&&t.clientProtocolHeaderRequired&&(e?e["X-Client-Protocol"]="webchannel":e={"X-Client-Protocol":"webchannel"}),this.g.s=e,e=t&&t.initMessageHeaders||null,t&&t.messageContentType&&(e?e["X-WebChannel-Content-Type"]=t.messageContentType:e={"X-WebChannel-Content-Type":t.messageContentType}),t&&t.Ca&&(e?e["X-WebChannel-Client-Profile"]=t.Ca:e={"X-WebChannel-Client-Profile":t.Ca}),this.g.U=e,(e=t&&t.cc)&&!kt(e)&&(this.g.o=e),this.A=t&&t.supportsCrossDomainXhr||!1,this.v=t&&t.sendRawJson||!1,(t=t&&t.httpSessionIdParam)&&!kt(t)&&(this.g.F=t,null!==(e=this.h)&&t in e&&(t in(e=this.h)&&delete e[t])),this.j=new Xs(this)}function Js(e){ai.call(this);var t=e.__sm__;if(t){e:{for(const n in t){e=n;break e}e=void 0}(this.i=e)&&(e=this.i,t=null!==t&&e in t?t[e]:void 0),this.data=t}else this.data=e}function Ys(){hi.call(this),this.status=1}function Xs(e){this.g=e}function Zs(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.m=Array(this.blockSize),this.i=this.h=0,this.reset()}function er(e,t,n){n||(n=0);var i=Array(16);if("string"==typeof t)for(var s=0;16>s;++s)i[s]=t.charCodeAt(n++)|t.charCodeAt(n++)<<8|t.charCodeAt(n++)<<16|t.charCodeAt(n++)<<24;else for(s=0;16>s;++s)i[s]=t[n++]|t[n++]<<8|t[n++]<<16|t[n++]<<24;t=e.g[0],n=e.g[1],s=e.g[2];var r=e.g[3],o=t+(r^n&(s^r))+i[0]+3614090360&4294967295;o=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=(n=(s=(r=(t=n+(o<<7&4294967295|o>>>25))+((o=r+(s^t&(n^s))+i[1]+3905402710&4294967295)<<12&4294967295|o>>>20))+((o=s+(n^r&(t^n))+i[2]+606105819&4294967295)<<17&4294967295|o>>>15))+((o=n+(t^s&(r^t))+i[3]+3250441966&4294967295)<<22&4294967295|o>>>10))+((o=t+(r^n&(s^r))+i[4]+4118548399&4294967295)<<7&4294967295|o>>>25))+((o=r+(s^t&(n^s))+i[5]+1200080426&4294967295)<<12&4294967295|o>>>20))+((o=s+(n^r&(t^n))+i[6]+2821735955&4294967295)<<17&4294967295|o>>>15))+((o=n+(t^s&(r^t))+i[7]+4249261313&4294967295)<<22&4294967295|o>>>10))+((o=t+(r^n&(s^r))+i[8]+1770035416&4294967295)<<7&4294967295|o>>>25))+((o=r+(s^t&(n^s))+i[9]+2336552879&4294967295)<<12&4294967295|o>>>20))+((o=s+(n^r&(t^n))+i[10]+4294925233&4294967295)<<17&4294967295|o>>>15))+((o=n+(t^s&(r^t))+i[11]+2304563134&4294967295)<<22&4294967295|o>>>10))+((o=t+(r^n&(s^r))+i[12]+1804603682&4294967295)<<7&4294967295|o>>>25))+((o=r+(s^t&(n^s))+i[13]+4254626195&4294967295)<<12&4294967295|o>>>20))+((o=s+(n^r&(t^n))+i[14]+2792965006&4294967295)<<17&4294967295|o>>>15))+((o=n+(t^s&(r^t))+i[15]+1236535329&4294967295)<<22&4294967295|o>>>10))+((o=t+(s^r&(n^s))+i[1]+4129170786&4294967295)<<5&4294967295|o>>>27))+((o=r+(n^s&(t^n))+i[6]+3225465664&4294967295)<<9&4294967295|o>>>23))+((o=s+(t^n&(r^t))+i[11]+643717713&4294967295)<<14&4294967295|o>>>18))+((o=n+(r^t&(s^r))+i[0]+3921069994&4294967295)<<20&4294967295|o>>>12))+((o=t+(s^r&(n^s))+i[5]+3593408605&4294967295)<<5&4294967295|o>>>27))+((o=r+(n^s&(t^n))+i[10]+38016083&4294967295)<<9&4294967295|o>>>23))+((o=s+(t^n&(r^t))+i[15]+3634488961&4294967295)<<14&4294967295|o>>>18))+((o=n+(r^t&(s^r))+i[4]+3889429448&4294967295)<<20&4294967295|o>>>12))+((o=t+(s^r&(n^s))+i[9]+568446438&4294967295)<<5&4294967295|o>>>27))+((o=r+(n^s&(t^n))+i[14]+3275163606&4294967295)<<9&4294967295|o>>>23))+((o=s+(t^n&(r^t))+i[3]+4107603335&4294967295)<<14&4294967295|o>>>18))+((o=n+(r^t&(s^r))+i[8]+1163531501&4294967295)<<20&4294967295|o>>>12))+((o=t+(s^r&(n^s))+i[13]+2850285829&4294967295)<<5&4294967295|o>>>27))+((o=r+(n^s&(t^n))+i[2]+4243563512&4294967295)<<9&4294967295|o>>>23))+((o=s+(t^n&(r^t))+i[7]+1735328473&4294967295)<<14&4294967295|o>>>18))+((o=n+(r^t&(s^r))+i[12]+2368359562&4294967295)<<20&4294967295|o>>>12))+((o=t+(n^s^r)+i[5]+4294588738&4294967295)<<4&4294967295|o>>>28))+((o=r+(t^n^s)+i[8]+2272392833&4294967295)<<11&4294967295|o>>>21))+((o=s+(r^t^n)+i[11]+1839030562&4294967295)<<16&4294967295|o>>>16))+((o=n+(s^r^t)+i[14]+4259657740&4294967295)<<23&4294967295|o>>>9))+((o=t+(n^s^r)+i[1]+2763975236&4294967295)<<4&4294967295|o>>>28))+((o=r+(t^n^s)+i[4]+1272893353&4294967295)<<11&4294967295|o>>>21))+((o=s+(r^t^n)+i[7]+4139469664&4294967295)<<16&4294967295|o>>>16))+((o=n+(s^r^t)+i[10]+3200236656&4294967295)<<23&4294967295|o>>>9))+((o=t+(n^s^r)+i[13]+681279174&4294967295)<<4&4294967295|o>>>28))+((o=r+(t^n^s)+i[0]+3936430074&4294967295)<<11&4294967295|o>>>21))+((o=s+(r^t^n)+i[3]+3572445317&4294967295)<<16&4294967295|o>>>16))+((o=n+(s^r^t)+i[6]+76029189&4294967295)<<23&4294967295|o>>>9))+((o=t+(n^s^r)+i[9]+3654602809&4294967295)<<4&4294967295|o>>>28))+((o=r+(t^n^s)+i[12]+3873151461&4294967295)<<11&4294967295|o>>>21))+((o=s+(r^t^n)+i[15]+530742520&4294967295)<<16&4294967295|o>>>16))+((o=n+(s^r^t)+i[2]+3299628645&4294967295)<<23&4294967295|o>>>9))+((o=t+(s^(n|~r))+i[0]+4096336452&4294967295)<<6&4294967295|o>>>26))+((o=r+(n^(t|~s))+i[7]+1126891415&4294967295)<<10&4294967295|o>>>22))+((o=s+(t^(r|~n))+i[14]+2878612391&4294967295)<<15&4294967295|o>>>17))+((o=n+(r^(s|~t))+i[5]+4237533241&4294967295)<<21&4294967295|o>>>11))+((o=t+(s^(n|~r))+i[12]+1700485571&4294967295)<<6&4294967295|o>>>26))+((o=r+(n^(t|~s))+i[3]+2399980690&4294967295)<<10&4294967295|o>>>22))+((o=s+(t^(r|~n))+i[10]+4293915773&4294967295)<<15&4294967295|o>>>17))+((o=n+(r^(s|~t))+i[1]+2240044497&4294967295)<<21&4294967295|o>>>11))+((o=t+(s^(n|~r))+i[8]+1873313359&4294967295)<<6&4294967295|o>>>26))+((o=r+(n^(t|~s))+i[15]+4264355552&4294967295)<<10&4294967295|o>>>22))+((o=s+(t^(r|~n))+i[6]+2734768916&4294967295)<<15&4294967295|o>>>17))+((o=n+(r^(s|~t))+i[13]+1309151649&4294967295)<<21&4294967295|o>>>11))+((r=(t=n+((o=t+(s^(n|~r))+i[4]+4149444226&4294967295)<<6&4294967295|o>>>26))+((o=r+(n^(t|~s))+i[11]+3174756917&4294967295)<<10&4294967295|o>>>22))^((s=r+((o=s+(t^(r|~n))+i[2]+718787259&4294967295)<<15&4294967295|o>>>17))|~t))+i[9]+3951481745&4294967295,e.g[0]=e.g[0]+t&4294967295,e.g[1]=e.g[1]+(s+(o<<21&4294967295|o>>>11))&4294967295,e.g[2]=e.g[2]+s&4294967295,e.g[3]=e.g[3]+r&4294967295}function tr(e,t){this.h=t;for(var n=[],i=!0,s=e.length-1;0<=s;s--){var r=0|e[s];i&&r==t||(n[s]=r,i=!1)}this.g=n}(rt=ps.prototype).Oa=function(e){this.M=e},rt.ha=function(e,t,n,i){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.I+"; newUri="+e);t=t?t.toUpperCase():"GET",this.I=e,this.j="",this.m=0,this.F=!1,this.h=!0,this.g=this.u?this.u.g():ri.g(),this.C=this.u?ii(this.u):ii(ri),this.g.onreadystatechange=yt(this.La,this);try{this.G=!0,this.g.open(t,String(e),!0),this.G=!1}catch(e){return void ws(this,e)}if(e=n||"",n=new Map(this.headers),i)if(Object.getPrototypeOf(i)===Object.prototype)for(var s in i)n.set(s,i[s]);else{if("function"!=typeof i.keys||"function"!=typeof i.get)throw Error("Unknown input type for opt_headers: "+String(i));for(const e of i.keys())n.set(e,i.get(e))}i=Array.from(n.keys()).find((e=>"content-type"==e.toLowerCase())),s=ct.FormData&&e instanceof ct.FormData,!(0<=_t(ys,t))||i||s||n.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[e,t]of n)this.g.setRequestHeader(e,t);this.K&&(this.g.responseType=this.K),"withCredentials"in this.g&&this.g.withCredentials!==this.M&&(this.g.withCredentials=this.M);try{Ts(this),0<this.B&&((this.L=function(e){return Mt&&xt(Kt,9,(function(){let e=0;const t=Ct(String(Ot)).split("."),n=Ct("9").split("."),i=Math.max(t.length,n.length);for(let o=0;0==e&&o<i;o++){var s=t[o]||"",r=n[o]||"";do{if(s=/(\d*)(\D*)(.*)/.exec(s)||["","","",""],r=/(\d*)(\D*)(.*)/.exec(r)||["","","",""],0==s[0].length&&0==r[0].length)break;e=At(0==s[1].length?0:parseInt(s[1],10),0==r[1].length?0:parseInt(r[1],10))||At(0==s[2].length,0==r[2].length)||At(s[2],r[2]),s=s[3],r=r[3]}while(0==e)}return 0<=e}))&&"number"==typeof e.timeout&&void 0!==e.ontimeout}(this.g))?(this.g.timeout=this.B,this.g.ontimeout=yt(this.ua,this)):this.A=Mn(this.ua,this.B,this)),this.v=!0,this.g.send(e),this.v=!1}catch(e){ws(this,e)}},rt.ua=function(){void 0!==ht&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,Tn(this,"timeout"),this.abort(8))},rt.abort=function(e){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=e||7,Tn(this,"complete"),Tn(this,"abort"),_s(this))},rt.N=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),_s(this,!0)),ps.$.N.call(this)},rt.La=function(){this.s||(this.G||this.v||this.l?bs(this):this.kb())},rt.kb=function(){bs(this)},rt.da=function(){try{return 2<Is(this)?this.g.status:-1}catch(e){return-1}},rt.ja=function(){try{return this.g?this.g.responseText:""}catch(e){return""}},rt.Wa=function(e){if(this.g){var t=this.g.responseText;return e&&0==t.indexOf(e)&&(t=t.substring(e.length)),fs(t)}},rt.Ia=function(){return this.m},rt.Sa=function(){return"string"==typeof this.j?this.j:String(this.j)},(rt=As.prototype).qa=8,rt.H=1,rt.Na=function(e){if(this.m)if(this.m=null,1==this.H){if(!e){this.W=Math.floor(1e5*Math.random()),e=this.W++;const s=new li(this,this.j,e,void 0);let r=this.s;if(this.U&&(r?(r=nn(r),rn(r,this.U)):r=this.U),null!==this.o||this.O||(s.I=r,r=null),this.P)e:{for(var t=0,n=0;n<this.i.length;n++){var i=this.i[n];if(void 0===(i="__data__"in i.g&&"string"==typeof(i=i.g.__data__)?i.length:void 0))break;if(4096<(t+=i)){t=n;break e}if(4096===t||n===this.i.length-1){t=n+1;break e}}t=1e3}else t=1e3;t=Ps(this,s,t),Oi(n=Ni(this.G),"RID",e),Oi(n,"CVER",22),this.F&&Oi(n,"X-HTTP-Session-Id",this.F),Ls(this,n),r&&(this.O?t="headers="+encodeURIComponent(String(Ss(r)))+"&"+t:this.o&&ks(n,this.o,r)),es(this.h,s),this.bb&&Oi(n,"TYPE","init"),this.P?(Oi(n,"$req",t),Oi(n,"SID","null"),s.ba=!0,mi(s,n,null)):mi(s,n,t),this.H=2}}else 3==this.H&&(e?Os(this,e):0==this.i.length||Yi(this.h)||Os(this))},rt.Ma=function(){if(this.u=null,Vs(this),this.ca&&!(this.L||null==this.g||0>=this.S)){var e=2*this.S;this.j.info("BP detection timer enabled: "+e),this.B=Zn(yt(this.jb,this),e)}},rt.jb=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.M=!1,this.L=!0,Yn(10),Ds(this),Vs(this))},rt.ib=function(){null!=this.v&&(this.v=null,Ds(this),Fs(this),Yn(19))},rt.pb=function(e){e?(this.j.info("Successfully pinged google.com"),Yn(2)):(this.j.info("Failed to ping google.com"),Yn(1))},(rt=Ws.prototype).Ba=function(){},rt.Aa=function(){},rt.za=function(){},rt.ya=function(){},rt.Va=function(){},Gs.prototype.g=function(e,t){return new Qs(e,t)},vt(Qs,_n),Qs.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.I=!0);var e=this.g,t=this.l,n=this.h||void 0;Yn(0),e.Y=t,e.ma=n||{},e.M=e.aa,e.G=$s(e,null,e.Y),xs(e)},Qs.prototype.close=function(){Ns(this.g)},Qs.prototype.u=function(e){var t=this.g;if("string"==typeof e){var n={};n.__data__=e,e=n}else this.v&&((n={}).__data__=En(e),e=n);t.i.push(new class{constructor(e,t){this.h=e,this.g=t}}(t.fb++,e)),3==t.H&&xs(t)},Qs.prototype.N=function(){this.g.l=null,delete this.j,Ns(this.g),delete this.g,Qs.$.N.call(this)},vt(Js,ai),vt(Ys,hi),vt(Xs,Ws),Xs.prototype.Ba=function(){Tn(this.g,"a")},Xs.prototype.Aa=function(e){Tn(this.g,new Js(e))},Xs.prototype.za=function(e){Tn(this.g,new Ys)},Xs.prototype.ya=function(){Tn(this.g,"b")},vt(Zs,(function(){this.blockSize=-1})),Zs.prototype.reset=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.i=this.h=0},Zs.prototype.j=function(e,t){void 0===t&&(t=e.length);for(var n=t-this.blockSize,i=this.m,s=this.h,r=0;r<t;){if(0==s)for(;r<=n;)er(this,e,r),r+=this.blockSize;if("string"==typeof e){for(;r<t;)if(i[s++]=e.charCodeAt(r++),s==this.blockSize){er(this,i),s=0;break}}else for(;r<t;)if(i[s++]=e[r++],s==this.blockSize){er(this,i),s=0;break}}this.h=s,this.i+=t},Zs.prototype.l=function(){var e=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);e[0]=128;for(var t=1;t<e.length-8;++t)e[t]=0;var n=8*this.i;for(t=e.length-8;t<e.length;++t)e[t]=255&n,n/=256;for(this.j(e),e=Array(16),t=n=0;4>t;++t)for(var i=0;32>i;i+=8)e[n++]=this.g[t]>>>i&255;return e};var nr={};function ir(e){return-128<=e&&128>e?xt(nr,e,(function(e){return new tr([0|e],0>e?-1:0)})):new tr([0|e],0>e?-1:0)}function sr(e){if(isNaN(e)||!isFinite(e))return or;if(0>e)return ur(sr(-e));for(var t=[],n=1,i=0;e>=n;i++)t[i]=e/n|0,n*=rr;return new tr(t,0)}var rr=4294967296,or=ir(0),ar=ir(1),hr=ir(16777216);function cr(e){if(0!=e.h)return!1;for(var t=0;t<e.g.length;t++)if(0!=e.g[t])return!1;return!0}function lr(e){return-1==e.h}function ur(e){for(var t=e.g.length,n=[],i=0;i<t;i++)n[i]=~e.g[i];return new tr(n,~e.h).add(ar)}function dr(e,t){return e.add(ur(t))}function fr(e,t){for(;(65535&e[t])!=e[t];)e[t+1]+=e[t]>>>16,e[t]&=65535,t++}function pr(e,t){this.g=e,this.h=t}function mr(e,t){if(cr(t))throw Error("division by zero");if(cr(e))return new pr(or,or);if(lr(e))return t=mr(ur(e),t),new pr(ur(t.g),ur(t.h));if(lr(t))return t=mr(e,ur(t)),new pr(ur(t.g),t.h);if(30<e.g.length){if(lr(e)||lr(t))throw Error("slowDivide_ only works with positive integers.");for(var n=ar,i=t;0>=i.X(e);)n=gr(n),i=gr(i);var s=yr(n,1),r=yr(i,1);for(i=yr(i,2),n=yr(n,2);!cr(i);){var o=r.add(i);0>=o.X(e)&&(s=s.add(n),r=o),i=yr(i,1),n=yr(n,1)}return t=dr(e,s.R(t)),new pr(s,t)}for(s=or;0<=e.X(t);){for(n=Math.max(1,Math.floor(e.ea()/t.ea())),i=48>=(i=Math.ceil(Math.log(n)/Math.LN2))?1:Math.pow(2,i-48),o=(r=sr(n)).R(t);lr(o)||0<o.X(e);)o=(r=sr(n-=i)).R(t);cr(r)&&(r=ar),s=s.add(r),e=dr(e,o)}return new pr(s,e)}function gr(e){for(var t=e.g.length+1,n=[],i=0;i<t;i++)n[i]=e.D(i)<<1|e.D(i-1)>>>31;return new tr(n,e.h)}function yr(e,t){var n=t>>5;t%=32;for(var i=e.g.length-n,s=[],r=0;r<i;r++)s[r]=0<t?e.D(r+n)>>>t|e.D(r+n+1)<<32-t:e.D(r+n);return new tr(s,e.h)}(rt=tr.prototype).ea=function(){if(lr(this))return-ur(this).ea();for(var e=0,t=1,n=0;n<this.g.length;n++){var i=this.D(n);e+=(0<=i?i:rr+i)*t,t*=rr}return e},rt.toString=function(e){if(2>(e=e||10)||36<e)throw Error("radix out of range: "+e);if(cr(this))return"0";if(lr(this))return"-"+ur(this).toString(e);for(var t=sr(Math.pow(e,6)),n=this,i="";;){var s=mr(n,t).g,r=((0<(n=dr(n,s.R(t))).g.length?n.g[0]:n.h)>>>0).toString(e);if(cr(n=s))return r+i;for(;6>r.length;)r="0"+r;i=r+i}},rt.D=function(e){return 0>e?0:e<this.g.length?this.g[e]:this.h},rt.X=function(e){return lr(e=dr(this,e))?-1:cr(e)?0:1},rt.abs=function(){return lr(this)?ur(this):this},rt.add=function(e){for(var t=Math.max(this.g.length,e.g.length),n=[],i=0,s=0;s<=t;s++){var r=i+(65535&this.D(s))+(65535&e.D(s)),o=(r>>>16)+(this.D(s)>>>16)+(e.D(s)>>>16);i=o>>>16,r&=65535,o&=65535,n[s]=o<<16|r}return new tr(n,-2147483648&n[n.length-1]?-1:0)},rt.R=function(e){if(cr(this)||cr(e))return or;if(lr(this))return lr(e)?ur(this).R(ur(e)):ur(ur(this).R(e));if(lr(e))return ur(this.R(ur(e)));if(0>this.X(hr)&&0>e.X(hr))return sr(this.ea()*e.ea());for(var t=this.g.length+e.g.length,n=[],i=0;i<2*t;i++)n[i]=0;for(i=0;i<this.g.length;i++)for(var s=0;s<e.g.length;s++){var r=this.D(i)>>>16,o=65535&this.D(i),a=e.D(s)>>>16,h=65535&e.D(s);n[2*i+2*s]+=o*h,fr(n,2*i+2*s),n[2*i+2*s+1]+=r*h,fr(n,2*i+2*s+1),n[2*i+2*s+1]+=o*a,fr(n,2*i+2*s+1),n[2*i+2*s+2]+=r*a,fr(n,2*i+2*s+2)}for(i=0;i<t;i++)n[i]=n[2*i+1]<<16|n[2*i];for(i=t;i<2*t;i++)n[i]=0;return new tr(n,0)},rt.gb=function(e){return mr(this,e).h},rt.and=function(e){for(var t=Math.max(this.g.length,e.g.length),n=[],i=0;i<t;i++)n[i]=this.D(i)&e.D(i);return new tr(n,this.h&e.h)},rt.or=function(e){for(var t=Math.max(this.g.length,e.g.length),n=[],i=0;i<t;i++)n[i]=this.D(i)|e.D(i);return new tr(n,this.h|e.h)},rt.xor=function(e){for(var t=Math.max(this.g.length,e.g.length),n=[],i=0;i<t;i++)n[i]=this.D(i)^e.D(i);return new tr(n,this.h^e.h)},Gs.prototype.createWebChannel=Gs.prototype.g,Qs.prototype.send=Qs.prototype.u,Qs.prototype.open=Qs.prototype.m,Qs.prototype.close=Qs.prototype.close,ei.NO_ERROR=0,ei.TIMEOUT=8,ei.HTTP_ERROR=6,ti.COMPLETE="complete",si.EventType=oi,oi.OPEN="a",oi.CLOSE="b",oi.ERROR="c",oi.MESSAGE="d",_n.prototype.listen=_n.prototype.O,ps.prototype.listenOnce=ps.prototype.P,ps.prototype.getLastError=ps.prototype.Sa,ps.prototype.getLastErrorCode=ps.prototype.Ia,ps.prototype.getStatus=ps.prototype.da,ps.prototype.getResponseJson=ps.prototype.Wa,ps.prototype.getResponseText=ps.prototype.ja,ps.prototype.send=ps.prototype.ha,ps.prototype.setWithCredentials=ps.prototype.Oa,Zs.prototype.digest=Zs.prototype.l,Zs.prototype.reset=Zs.prototype.reset,Zs.prototype.update=Zs.prototype.j,tr.prototype.add=tr.prototype.add,tr.prototype.multiply=tr.prototype.R,tr.prototype.modulo=tr.prototype.gb,tr.prototype.compare=tr.prototype.X,tr.prototype.toNumber=tr.prototype.ea,tr.prototype.toString=tr.prototype.toString,tr.prototype.getBits=tr.prototype.D,tr.fromNumber=sr,tr.fromString=function e(t,n){if(0==t.length)throw Error("number format error: empty string");if(2>(n=n||10)||36<n)throw Error("radix out of range: "+n);if("-"==t.charAt(0))return ur(e(t.substring(1),n));if(0<=t.indexOf("-"))throw Error('number format error: interior "-" character');for(var i=sr(Math.pow(n,8)),s=or,r=0;r<t.length;r+=8){var o=Math.min(8,t.length-r),a=parseInt(t.substring(r,r+o),n);8>o?(o=sr(Math.pow(n,o)),s=s.R(o).add(sr(a))):s=(s=s.R(i)).add(sr(a))}return s};var wr=at.createWebChannelTransport=function(){return new Gs},vr=at.getStatEventTarget=function(){return Wn()},br=at.ErrorCode=ei,_r=at.EventType=ti,Tr=at.Event=$n,Ir=at.Stat={xb:0,Ab:1,Bb:2,Ub:3,Zb:4,Wb:5,Xb:6,Vb:7,Tb:8,Yb:9,PROXY:10,NOPROXY:11,Rb:12,Nb:13,Ob:14,Mb:15,Pb:16,Qb:17,tb:18,sb:19,ub:20},Er=at.FetchXmlHttpFactory=as,Sr=at.WebChannel=si,kr=at.XhrIo=ps,Cr=at.Md5=Zs,Ar=at.Integer=tr;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fr(e="Unexpected state"){const t=`FIRESTORE (${Dr}) INTERNAL ASSERTION FAILED: `+e;throw Lr(t),new Error(t)}function Ur(e,t){e||Fr()}function Vr(e,t){return e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jr={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class qr extends J{constructor(e,t){super(e,t),this.code=e,this.message=t,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hr{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class zr{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(Nr.UNAUTHENTICATED)))}shutdown(){}}class $r{getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable((()=>t(this.token.user)))}shutdown(){this.changeListener=null}constructor(e){this.token=e,this.changeListener=null}}class Kr{start(e,t){let n=this.i;const i=e=>this.i!==n?(n=this.i,t(e)):Promise.resolve();let s=new Br;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new Br,e.enqueueRetryable((()=>i(this.currentUser)))};const r=()=>{const t=s;e.enqueueRetryable((async()=>{await t.promise,await i(this.currentUser)}))},o=e=>{Or("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=e,this.auth.addAuthTokenListener(this.o),r()};this.t.onInit((e=>o(e))),setTimeout((()=>{if(!this.auth){const e=this.t.getImmediate({optional:!0});e?o(e):(Or("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new Br)}}),0),r()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((t=>this.i!==e?(Or("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):t?(Ur("string"==typeof t.accessToken),new Hr(t.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return Ur(null===e||"string"==typeof e),new Nr(e)}constructor(e){this.t=e,this.currentUser=Nr.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}}class Wr{p(){return this.m?this.m():null}get headers(){this.g.set("X-Goog-AuthUser",this.h);const e=this.p();return e&&this.g.set("Authorization",e),this.l&&this.g.set("X-Goog-Iam-Authorization-Token",this.l),this.g}constructor(e,t,n){this.h=e,this.l=t,this.m=n,this.type="FirstParty",this.user=Nr.FIRST_PARTY,this.g=new Map}}class Gr{getToken(){return Promise.resolve(new Wr(this.h,this.l,this.m))}start(e,t){e.enqueueRetryable((()=>t(Nr.FIRST_PARTY)))}shutdown(){}invalidateToken(){}constructor(e,t,n){this.h=e,this.l=t,this.m=n}}class Qr{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Jr{start(e,t){const n=e=>{null!=e.error&&Or("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${e.error.message}`);const n=e.token!==this.T;return this.T=e.token,Or("FirebaseAppCheckTokenProvider",`Received ${n?"new":"existing"} token.`),n?t(e.token):Promise.resolve()};this.o=t=>{e.enqueueRetryable((()=>n(t)))};const i=e=>{Or("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=e,this.appCheck.addTokenListener(this.o)};this.I.onInit((e=>i(e))),setTimeout((()=>{if(!this.appCheck){const e=this.I.getImmediate({optional:!0});e?i(e):Or("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((e=>e?(Ur("string"==typeof e.token),this.T=e.token,new Qr(e.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}constructor(e){this.I=e,this.forceRefresh=!1,this.appCheck=null,this.T=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Yr(e){const t="undefined"!=typeof self&&(self.crypto||self.msCrypto),n=new Uint8Array(e);if(t&&"function"==typeof t.getRandomValues)t.getRandomValues(n);else for(let t=0;t<e;t++)n[t]=Math.floor(256*Math.random());return n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xr{static A(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=Math.floor(256/e.length)*e.length;let n="";for(;n.length<20;){const i=Yr(40);for(let s=0;s<i.length;++s)n.length<20&&i[s]<t&&(n+=e.charAt(i[s]%e.length))}return n}}function Zr(e,t){return e<t?-1:e>t?1:0}function eo(e,t,n){return e.length===t.length&&e.every(((e,i)=>n(e,t[i])))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function go(e){if(e.code!==jr.FAILED_PRECONDITION||e.message!==po)throw e;Or("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class vo{ot(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.ut&&this.ut(e),e}constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=e=>this.ot(e),this.ut=e=>t.writeSequenceNumber(e))}}function bo(e){return null==e}function _o(e){return 0===e&&1/e==-1/0}function To(e){return"number"==typeof e&&Number.isInteger(e)&&!_o(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function ko(e){let t=0;for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t++;return t}function Co(e,t){for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n,e[n])}function Ao(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{static fromBase64String(e){const t=function(e){try{return atob(e)}catch(e){throw"undefined"!=typeof DOMException&&e instanceof DOMException?new Po("Invalid base64 string: "+e):e}}(e);return new Fo(t)}static fromUint8Array(e){const t=function(e){let t="";for(let n=0;n<e.length;++n)t+=String.fromCharCode(e[n]);return t}(e);return new Fo(t)}[Mo](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){var e;return e=this.binaryString,btoa(e)}toUint8Array(){return function(e){const t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Zr(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}constructor(e){this.binaryString=e}}Fo.EMPTY_BYTE_STRING=new Fo("");const Uo=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Vo(e){if(Ur(!!e),"string"==typeof e){let t=0;const n=Uo.exec(e);if(Ur(!!n),n[1]){let e=n[1];e=(e+"000000000").substr(0,9),t=Number(e)}const i=new Date(e);return{seconds:Math.floor(i.getTime()/1e3),nanos:t}}return{seconds:jo(e.seconds),nanos:jo(e.nanos)}}function jo(e){return"number"==typeof e?e:"string"==typeof e?Number(e):0}function qo(e){return"string"==typeof e?Fo.fromBase64String(e):Fo.fromUint8Array(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bo(e){var t,n;return"server_timestamp"===(null===(n=((null===(t=null==e?void 0:e.mapValue)||void 0===t?void 0:t.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function Ho(e){const t=e.mapValue.fields.__previous_value__;return Bo(t)?Ho(t):t}function zo(e){const t=Vo(e.mapValue.fields.__local_write_time__.timestampValue);return new to(t.seconds,t.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $o{constructor(e,t,n,i,s,r,o,a,h){this.databaseId=e,this.appId=t,this.persistenceKey=n,this.host=i,this.ssl=s,this.forceLongPolling=r,this.autoDetectLongPolling=o,this.longPollingOptions=a,this.useFetchStreams=h}}class Ko{static empty(){return new Ko("","")}get isDefaultDatabase(){return"(default)"===this.database}isEqual(e){return e instanceof Ko&&e.projectId===this.projectId&&e.database===this.database}constructor(e,t){this.projectId=e,this.database=t||"(default)"}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class da{constructor(e,t){this.position=e,this.inclusive=t}}function fa(e,t,n){let i=0;for(let s=0;s<e.position.length;s++){const r=t[s],o=e.position[s];if(i=r.field.isKeyField()?ao.comparator(ao.fromName(o.referenceValue),n.key):Yo(o,n.data.field(r.field)),"desc"===r.dir&&(i*=-1),0!==i)break}return i}function pa(e,t){if(null===e)return null===t;if(null===t)return!1;if(e.inclusive!==t.inclusive||e.position.length!==t.position.length)return!1;for(let n=0;n<e.position.length;n++)if(!Qo(e.position[n],t.position[n]))return!1;return!0}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
class Va{constructor(e,t=null,n=[],i=[],s=null,r="F",o=null,a=null){this.path=e,this.collectionGroup=t,this.explicitOrderBy=n,this.filters=i,this.limit=s,this.limitType=r,this.startAt=o,this.endAt=a,this.wt=null,this._t=null,this.startAt,this.endAt}}function ja(e,t,n,i,s,r,o,a){return new Va(e,t,n,i,s,r,o,a)}function qa(e){return new Va(e)}function Ba(e){return 0===e.filters.length&&null===e.limit&&null==e.startAt&&null==e.endAt&&(0===e.explicitOrderBy.length||1===e.explicitOrderBy.length&&e.explicitOrderBy[0].field.isKeyField())}function Ha(e){return e.explicitOrderBy.length>0?e.explicitOrderBy[0].field:null}function za(e){for(const t of e.filters){const e=t.getFirstInequalityField();if(null!==e)return e}return null}function $a(e){return null!==e.collectionGroup}function Ka(e){const t=Vr(e);if(null===t.wt){t.wt=[];const e=za(t),n=Ha(t);if(null!==e&&null===n)e.isKeyField()||t.wt.push(new ma(e)),t.wt.push(new ma(oo.keyField(),"asc"));else{let e=!1;for(const n of t.explicitOrderBy)t.wt.push(n),n.field.isKeyField()&&(e=!0);if(!e){const e=t.explicitOrderBy.length>0?t.explicitOrderBy[t.explicitOrderBy.length-1].dir:"asc";t.wt.push(new ma(oo.keyField(),e))}}}return t.wt}function Wa(e){const t=Vr(e);if(!t._t)if("F"===t.limitType)t._t=Pa(t.path,t.collectionGroup,Ka(t),t.filters,t.limit,t.startAt,t.endAt);else{const e=[];for(const n of Ka(t)){const t="desc"===n.dir?"asc":"desc";e.push(new ma(n.field,t))}const n=t.endAt?new da(t.endAt.position,t.endAt.inclusive):null,i=t.startAt?new da(t.startAt.position,t.startAt.inclusive):null;t._t=Pa(t.path,t.collectionGroup,e,t.filters,t.limit,n,i)}return t._t}function Ga(e,t){t.getFirstInequalityField(),za(e);const n=e.filters.concat([t]);return new Va(e.path,e.collectionGroup,e.explicitOrderBy.slice(),n,e.limit,e.limitType,e.startAt,e.endAt)}function Qa(e,t,n){return new Va(e.path,e.collectionGroup,e.explicitOrderBy.slice(),e.filters.slice(),t,n,e.startAt,e.endAt)}function Ja(e,t){return Fa(Wa(e),Wa(t))&&e.limitType===t.limitType}function Ya(e){return`${Ma(Wa(e))}|lt:${e.limitType}`}function Xa(e){return`Query(target=${function(e){let t=e.path.canonicalString();return null!==e.collectionGroup&&(t+=" collectionGroup="+e.collectionGroup),e.filters.length>0&&(t+=`, filters: [${e.filters.map((e=>Sa(e))).join(", ")}]`),bo(e.limit)||(t+=", limit: "+e.limit),e.orderBy.length>0&&(t+=`, orderBy: [${e.orderBy.map((e=>{return`${(t=e).field.canonicalString()} (${t.dir})`;var t})).join(", ")}]`),e.startAt&&(t+=", startAt: ",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map((e=>Zo(e))).join(",")),e.endAt&&(t+=", endAt: ",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map((e=>Zo(e))).join(",")),`Target(${t})`}(Wa(e))}; limitType=${e.limitType})`}function Za(e,t){return t.isFoundDocument()&&function(e,t){const n=t.key.path;return null!==e.collectionGroup?t.key.hasCollectionId(e.collectionGroup)&&e.path.isPrefixOf(n):ao.isDocumentKey(e.path)?e.path.isEqual(n):e.path.isImmediateParentOf(n)}(e,t)&&function(e,t){for(const n of Ka(e))if(!n.field.isKeyField()&&null===t.data.field(n.field))return!1;return!0}(e,t)&&function(e,t){for(const n of e.filters)if(!n.matches(t))return!1;return!0}(e,t)&&(i=t,!((n=e).startAt&&!function(e,t,n){const i=fa(e,t,n);return e.inclusive?i<=0:i<0}(n.startAt,Ka(n),i)||n.endAt&&!function(e,t,n){const i=fa(e,t,n);return e.inclusive?i>=0:i>0}(n.endAt,Ka(n),i)));var n,i}function eh(e){return e.collectionGroup||(e.path.length%2==1?e.path.lastSegment():e.path.get(e.path.length-2))}function th(e){return(t,n)=>{let i=!1;for(const s of Ka(e)){const e=nh(s,t,n);if(0!==e)return e;i=i||s.field.isKeyField()}return 0}}function nh(e,t,n){const i=e.field.isKeyField()?ao.comparator(t.key,n.key):function(e,t,n){const i=t.data.field(e),s=n.data.field(e);return null!==i&&null!==s?Yo(i,s):Fr()}(e.field,t,n);switch(e.dir){case"asc":return i;case"desc":return-1*i;default:return Fr()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yh(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:_o(t)?"-0":t}}function wh(e){return{integerValue:""+e}}function vh(e,t){return To(t)?wh(t):yh(e,t)}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bh{constructor(){this._=void 0}}function _h(e,t,n){return e instanceof Eh?Sh(e,t):e instanceof kh?Ch(e,t):n}function Th(e,t){var n,i;return e instanceof Ah?na(n=t)||(i=n)&&"doubleValue"in i?t:{integerValue:0}:null}class Ih extends bh{}class Eh extends bh{constructor(e){super(),this.elements=e}}function Sh(e,t){const n=Dh(t);for(const t of e.elements)n.some((e=>Qo(e,t)))||n.push(t);return{arrayValue:{values:n}}}class kh extends bh{constructor(e){super(),this.elements=e}}function Ch(e,t){let n=Dh(t);for(const t of e.elements)n=n.filter((e=>!Qo(e,t)));return{arrayValue:{values:n}}}class Ah extends bh{constructor(e,t){super(),this.serializer=e,this.gt=t}}function Nh(e){return jo(e.integerValue||e.doubleValue)}function Dh(e){return ia(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rh{constructor(e,t){this.version=e,this.transformResults=t}}class xh{static none(){return new xh}static exists(e){return new xh(void 0,e)}static updateTime(e){return new xh(e)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}constructor(e,t){this.updateTime=e,this.exists=t}}function Oh(e,t){return void 0!==e.updateTime?t.isFoundDocument()&&t.version.isEqual(e.updateTime):void 0===e.exists||e.exists===t.isFoundDocument()}class Lh{}function Ph(e,t){if(!e.hasLocalMutations||t&&0===t.fields.length)return null;if(null===t)return e.isNoDocument()?new $h(e.key,xh.none()):new jh(e.key,e.data,xh.none());{const n=e.data,i=ca.empty();let s=new xo(oo.comparator);for(let e of t.fields)if(!s.has(e)){let t=n.field(e);null===t&&e.length>1&&(e=e.popLast(),t=n.field(e)),null===t?i.delete(e):i.set(e,t),s=s.add(e)}return new qh(e.key,i,new Lo(s.toArray()),xh.none())}}function Mh(e,t,n){var i;e instanceof jh?function(e,t,n){const i=e.value.clone(),s=Hh(e.fieldTransforms,t,n.transformResults);i.setAll(s),t.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(e,t,n):e instanceof qh?function(e,t,n){if(!Oh(e.precondition,t))return void t.convertToUnknownDocument(n.version);const i=Hh(e.fieldTransforms,t,n.transformResults),s=t.data;s.setAll(Bh(e)),s.setAll(i),t.convertToFoundDocument(n.version,s).setHasCommittedMutations()}(e,t,n):(i=n,t.convertToNoDocument(i.version).setHasCommittedMutations())}function Fh(e,t,n,i){return e instanceof jh?function(e,t,n,i){if(!Oh(e.precondition,t))return n;const s=e.value.clone(),r=zh(e.fieldTransforms,i,t);return s.setAll(r),t.convertToFoundDocument(t.version,s).setHasLocalMutations(),null}(e,t,n,i):e instanceof qh?function(e,t,n,i){if(!Oh(e.precondition,t))return n;const s=zh(e.fieldTransforms,i,t),r=t.data;return r.setAll(Bh(e)),r.setAll(s),t.convertToFoundDocument(t.version,r).setHasLocalMutations(),null===n?null:n.unionWith(e.fieldMask.fields).unionWith(e.fieldTransforms.map((e=>e.field)))}(e,t,n,i):(s=t,r=n,Oh(e.precondition,s)?(s.convertToNoDocument(s.version).setHasLocalMutations(),null):r);var s,r}function Uh(e,t){let n=null;for(const i of e.fieldTransforms){const e=t.data.field(i.field),s=Th(i.transform,e||null);null!=s&&(null===n&&(n=ca.empty()),n.set(i.field,s))}return n||null}function Vh(e,t){return e.type===t.type&&!!e.key.isEqual(t.key)&&!!e.precondition.isEqual(t.precondition)&&(n=e.fieldTransforms,i=t.fieldTransforms,!!(void 0===n&&void 0===i||n&&i&&eo(n,i,((e,t)=>function(e,t){return e.field.isEqual(t.field)&&(n=e.transform,i=t.transform,n instanceof Eh&&i instanceof Eh||n instanceof kh&&i instanceof kh?eo(n.elements,i.elements,Qo):n instanceof Ah&&i instanceof Ah?Qo(n.gt,i.gt):n instanceof Ih&&i instanceof Ih);var n,i}(e,t)))))&&(0===e.type?e.value.isEqual(t.value):1!==e.type||e.data.isEqual(t.data)&&e.fieldMask.isEqual(t.fieldMask));var n,i}class jh extends Lh{getFieldMask(){return null}constructor(e,t,n,i=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=i,this.type=0}}class qh extends Lh{getFieldMask(){return this.fieldMask}constructor(e,t,n,i,s=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=i,this.fieldTransforms=s,this.type=1}}function Bh(e){const t=new Map;return e.fieldMask.fields.forEach((n=>{if(!n.isEmpty()){const i=e.data.field(n);t.set(n,i)}})),t}function Hh(e,t,n){const i=new Map;Ur(e.length===n.length);for(let s=0;s<n.length;s++){const r=e[s],o=r.transform,a=t.data.field(r.field);i.set(r.field,_h(o,a,n[s]))}return i}function zh(e,t,n){const i=new Map;for(const a of e){const e=a.transform,h=n.data.field(a.field);i.set(a.field,(r=h,o=t,(s=e)instanceof Ih?function(e,t){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:e.seconds,nanos:e.nanoseconds}}}};return t&&Bo(t)&&(t=Ho(t)),t&&(n.fields.__previous_value__=t),{mapValue:n}}(o,r):s instanceof Eh?Sh(s,r):s instanceof kh?Ch(s,r):function(e,t){const n=Th(e,t),i=Nh(n)+Nh(e.gt);return na(n)&&na(e.gt)?wh(i):yh(e.serializer,i)}(s,r)))}var s,r,o;return i}class $h extends Lh{getFieldMask(){return null}constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}}class Kh extends Lh{getFieldMask(){return null}constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Jh{constructor(e,t){this.count=e,this.unchangedNames=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Yh,Xh;function Zh(e){switch(e){default:return Fr();case jr.CANCELLED:case jr.UNKNOWN:case jr.DEADLINE_EXCEEDED:case jr.RESOURCE_EXHAUSTED:case jr.INTERNAL:case jr.UNAVAILABLE:case jr.UNAUTHENTICATED:return!1;case jr.INVALID_ARGUMENT:case jr.NOT_FOUND:case jr.ALREADY_EXISTS:case jr.PERMISSION_DENIED:case jr.FAILED_PRECONDITION:case jr.ABORTED:case jr.OUT_OF_RANGE:case jr.UNIMPLEMENTED:case jr.DATA_LOSS:return!0}}function ec(e){if(void 0===e)return Lr("GRPC error has no .code"),jr.UNKNOWN;switch(e){case Yh.OK:return jr.OK;case Yh.CANCELLED:return jr.CANCELLED;case Yh.UNKNOWN:return jr.UNKNOWN;case Yh.DEADLINE_EXCEEDED:return jr.DEADLINE_EXCEEDED;case Yh.RESOURCE_EXHAUSTED:return jr.RESOURCE_EXHAUSTED;case Yh.INTERNAL:return jr.INTERNAL;case Yh.UNAVAILABLE:return jr.UNAVAILABLE;case Yh.UNAUTHENTICATED:return jr.UNAUTHENTICATED;case Yh.INVALID_ARGUMENT:return jr.INVALID_ARGUMENT;case Yh.NOT_FOUND:return jr.NOT_FOUND;case Yh.ALREADY_EXISTS:return jr.ALREADY_EXISTS;case Yh.PERMISSION_DENIED:return jr.PERMISSION_DENIED;case Yh.FAILED_PRECONDITION:return jr.FAILED_PRECONDITION;case Yh.ABORTED:return jr.ABORTED;case Yh.OUT_OF_RANGE:return jr.OUT_OF_RANGE;case Yh.UNIMPLEMENTED:return jr.UNIMPLEMENTED;case Yh.DATA_LOSS:return jr.DATA_LOSS;default:return Fr()}}(Xh=Yh||(Yh={}))[Xh.OK=0]="OK",Xh[Xh.CANCELLED=1]="CANCELLED",Xh[Xh.UNKNOWN=2]="UNKNOWN",Xh[Xh.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",Xh[Xh.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",Xh[Xh.NOT_FOUND=5]="NOT_FOUND",Xh[Xh.ALREADY_EXISTS=6]="ALREADY_EXISTS",Xh[Xh.PERMISSION_DENIED=7]="PERMISSION_DENIED",Xh[Xh.UNAUTHENTICATED=16]="UNAUTHENTICATED",Xh[Xh.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",Xh[Xh.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",Xh[Xh.ABORTED=10]="ABORTED",Xh[Xh.OUT_OF_RANGE=11]="OUT_OF_RANGE",Xh[Xh.UNIMPLEMENTED=12]="UNIMPLEMENTED",Xh[Xh.INTERNAL=13]="INTERNAL",Xh[Xh.UNAVAILABLE=14]="UNAVAILABLE",Xh[Xh.DATA_LOSS=15]="DATA_LOSS";
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qc{constructor(e){this.fe=e}}function Jc(e){const t=Vc({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?Qa(t,t.limit,"L"):t}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rl{getBundleMetadata(e,t){return yo.resolve(this.cs.get(t))}saveBundleMetadata(e,t){var n;return this.cs.set(t.id,{id:(n=t).id,version:n.version,createTime:kc(n.createTime)}),yo.resolve()}getNamedQuery(e,t){return yo.resolve(this.hs.get(t))}saveNamedQuery(e,t){return this.hs.set(t.name,{name:(n=t).name,query:Jc(n.bundledQuery),readTime:kc(n.readTime)}),yo.resolve();var n}constructor(e){this.serializer=e,this.cs=new Map,this.hs=new Map}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ul(e){return new _c(e,!0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jl{Uo(){return 1===this.state||5===this.state||this.Ko()}Ko(){return 2===this.state||3===this.state}start(){4!==this.state?this.auth():this.Go()}async stop(){this.Uo()&&await this.close(0)}Qo(){this.state=0,this.qo.reset()}jo(){this.Ko()&&null===this.Bo&&(this.Bo=this.ii.enqueueAfterDelay(this.$o,6e4,(()=>this.zo())))}Wo(e){this.Ho(),this.stream.send(e)}async zo(){if(this.Ko())return this.close(0)}Ho(){this.Bo&&(this.Bo.cancel(),this.Bo=null)}Jo(){this.Lo&&(this.Lo.cancel(),this.Lo=null)}async close(e,t){this.Ho(),this.Jo(),this.qo.cancel(),this.Fo++,4!==e?this.qo.reset():t&&t.code===jr.RESOURCE_EXHAUSTED?(Lr(t.toString()),Lr("Using maximum backoff delay to prevent overloading the backend."),this.qo.xo()):t&&t.code===jr.UNAUTHENTICATED&&3!==this.state&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),null!==this.stream&&(this.Yo(),this.stream.close(),this.stream=null),this.state=e,await this.listener.ao(t)}Yo(){}auth(){this.state=1;const e=this.Xo(this.Fo),t=this.Fo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([e,n])=>{this.Fo===t&&this.Zo(e,n)}),(t=>{e((()=>{const e=new qr(jr.UNKNOWN,"Fetching auth token failed: "+t.message);return this.tu(e)}))}))}Zo(e,t){const n=this.Xo(this.Fo);this.stream=this.eu(e,t),this.stream.uo((()=>{n((()=>(this.state=2,this.Lo=this.ii.enqueueAfterDelay(this.Oo,1e4,(()=>(this.Ko()&&(this.state=3),Promise.resolve()))),this.listener.uo())))})),this.stream.ao((e=>{n((()=>this.tu(e)))})),this.stream.onMessage((e=>{n((()=>this.onMessage(e)))}))}Go(){this.state=5,this.qo.No((async()=>{this.state=0,this.start()}))}tu(e){return Or("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(4,e)}Xo(e){return t=>{this.ii.enqueueAndForget((()=>this.Fo===e?t():(Or("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}constructor(e,t,n,i,s,r,o,a){this.ii=e,this.$o=n,this.Oo=i,this.connection=s,this.authCredentialsProvider=r,this.appCheckCredentialsProvider=o,this.listener=a,this.state=0,this.Fo=0,this.Bo=null,this.Lo=null,this.stream=null,this.qo=new Vl(e,t)}}class ql extends jl{eu(e,t){return this.connection.Ro("Listen",e,t)}onMessage(e){this.qo.reset();const t=function(e,t){let n;if("targetChange"in t){t.targetChange;const s="NO_CHANGE"===(i=t.targetChange.targetChangeType||"NO_CHANGE")?0:"ADD"===i?1:"REMOVE"===i?2:"CURRENT"===i?3:"RESET"===i?4:Fr(),r=t.targetChange.targetIds||[],o=function(e,t){return e.useProto3Json?(Ur(void 0===t||"string"==typeof t),Fo.fromBase64String(t||"")):(Ur(void 0===t||t instanceof Uint8Array),Fo.fromUint8Array(t||new Uint8Array))}(e,t.targetChange.resumeToken),a=t.targetChange.cause,h=a&&function(e){const t=void 0===e.code?jr.UNKNOWN:ec(e.code);return new qr(t,e.message||"")}(a);n=new fc(s,r,o,h||null)}else if("documentChange"in t){t.documentChange;const i=t.documentChange;i.document,i.document.name,i.document.updateTime;const s=Dc(e,i.document.name),r=kc(i.document.updateTime),o=i.document.createTime?kc(i.document.createTime):no.min(),a=new ca({mapValue:{fields:i.document.fields}}),h=ua.newFoundDocument(s,r,o,a),c=i.targetIds||[],l=i.removedTargetIds||[];n=new uc(c,l,h.key,h)}else if("documentDelete"in t){t.documentDelete;const i=t.documentDelete;i.document;const s=Dc(e,i.document),r=i.readTime?kc(i.readTime):no.min(),o=ua.newNoDocument(s,r),a=i.removedTargetIds||[];n=new uc([],a,o.key,o)}else if("documentRemove"in t){t.documentRemove;const i=t.documentRemove;i.document;const s=Dc(e,i.document),r=i.removedTargetIds||[];n=new uc([],r,s,null)}else{if(!("filter"in t))return Fr();{t.filter;const e=t.filter;e.targetId;const{count:i=0,unchangedNames:s}=e,r=new Jh(i,s),o=e.targetId;n=new dc(o,r)}}var i;return n}(this.serializer,e),n=function(e){if(!("targetChange"in e))return no.min();const t=e.targetChange;return t.targetIds&&t.targetIds.length?no.min():t.readTime?kc(t.readTime):no.min()}(e);return this.listener.nu(t,n)}su(e){const t={};t.database=Oc(this.serializer),t.addTarget=function(e,t){let n;const i=t.target;if(n=Ua(i)?{documents:Fc(e,i)}:{query:Uc(e,i)},n.targetId=t.targetId,t.resumeToken.approximateByteSize()>0){n.resumeToken=Ec(e,t.resumeToken);const i=Tc(e,t.expectedCount);null!==i&&(n.expectedCount=i)}else if(t.snapshotVersion.compareTo(no.min())>0){n.readTime=Ic(e,t.snapshotVersion.toTimestamp());const i=Tc(e,t.expectedCount);null!==i&&(n.expectedCount=i)}return n}(this.serializer,e);const n=function(e,t){const n=function(e){switch(e){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return Fr()}}(t.purpose);return null==n?null:{"goog-listen-tags":n}}(this.serializer,e);n&&(t.labels=n),this.Wo(t)}iu(e){const t={};t.database=Oc(this.serializer),t.removeTarget=e,this.Wo(t)}constructor(e,t,n,i,s,r){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,i,r),this.serializer=s}}class Bl extends jl{get ou(){return this.ru}start(){this.ru=!1,this.lastStreamToken=void 0,super.start()}Yo(){this.ru&&this.uu([])}eu(e,t){return this.connection.Ro("Write",e,t)}onMessage(e){if(Ur(!!e.streamToken),this.lastStreamToken=e.streamToken,this.ru){this.qo.reset();const i=(t=e.writeResults,n=e.commitTime,t&&t.length>0?(Ur(void 0!==n),t.map((e=>function(e,t){let n=e.updateTime?kc(e.updateTime):kc(t);return n.isEqual(no.min())&&(n=kc(t)),new Rh(n,e.transformResults||[])}(e,n)))):[]),s=kc(e.commitTime);return this.listener.cu(s,i)}var t,n;return Ur(!e.writeResults||0===e.writeResults.length),this.ru=!0,this.listener.au()}hu(){const e={};e.database=Oc(this.serializer),this.Wo(e)}uu(e){const t={streamToken:this.lastStreamToken,writes:e.map((e=>Mc(this.serializer,e)))};this.Wo(t)}constructor(e,t,n,i,s,r){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,i,r),this.serializer=s,this.ru=!1}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $l{constructor(e,t,n,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Eu=[],this.Au=new Map,this.vu=new Set,this.Ru=[],this.Pu=s,this.Pu.Yr((e=>{n.enqueueAndForget((async()=>{eu(this)&&(Or("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=Vr(e);t.vu.add(4),await Wl(t),t.bu.set("Unknown"),t.vu.delete(4),await Kl(t)}(this))}))})),this.bu=new zl(n,i)}}async function Kl(e){if(eu(e))for(const t of e.Ru)await t(!0)}async function Wl(e){for(const t of e.Ru)await t(!1)}function Gl(e,t){const n=Vr(e);n.Au.has(t.targetId)||(n.Au.set(t.targetId,t),Zl(n)?Xl(n):wu(n).Ko()&&Jl(n,t))}function Ql(e,t){const n=Vr(e),i=wu(n);n.Au.delete(t),i.Ko()&&Yl(n,t),0===n.Au.size&&(i.Ko()?i.jo():eu(n)&&n.bu.set("Unknown"))}function Jl(e,t){if(e.Vu.qt(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(no.min())>0){const n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}wu(e).su(t)}function Yl(e,t){e.Vu.qt(t),wu(e).iu(t)}function Xl(e){e.Vu=new mc({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),le:t=>e.Au.get(t)||null,ue:()=>e.datastore.serializer.databaseId}),wu(e).start(),e.bu.gu()}function Zl(e){return eu(e)&&!wu(e).Uo()&&e.Au.size>0}function eu(e){return 0===Vr(e).vu.size}function tu(e){e.Vu=void 0}async function nu(e){e.Au.forEach(((t,n)=>{Jl(e,t)}))}async function iu(e,t){tu(e),Zl(e)?(e.bu.Iu(t),Xl(e)):e.bu.set("Unknown")}async function su(e,t,n){if(e.bu.set("Online"),t instanceof fc&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const i of t.targetIds)e.Au.has(i)&&(await e.remoteSyncer.rejectListen(i,n),e.Au.delete(i),e.Vu.removeTarget(i))}(e,t)}catch(n){Or("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),n),await ru(e,n)}else if(t instanceof uc?e.Vu.Ht(t):t instanceof dc?e.Vu.ne(t):e.Vu.Xt(t),!n.isEqual(no.min()))try{const t=await _l(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.Vu.ce(t);return n.targetChanges.forEach(((n,i)=>{if(n.resumeToken.approximateByteSize()>0){const s=e.Au.get(i);s&&e.Au.set(i,s.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach(((t,n)=>{const i=e.Au.get(t);if(!i)return;e.Au.set(t,i.withResumeToken(Fo.EMPTY_BYTE_STRING,i.snapshotVersion)),Yl(e,t);const s=new Gc(i.target,t,n,i.sequenceNumber);Jl(e,s)})),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){Or("RemoteStore","Failed to raise snapshot:",t),await ru(e,t)}}async function ru(e,t,n){if(!wo(t))throw t;e.vu.add(1),await Wl(e),e.bu.set("Offline"),n||(n=()=>_l(e.localStore)),e.asyncQueue.enqueueRetryable((async()=>{Or("RemoteStore","Retrying IndexedDB access"),await n(),e.vu.delete(1),await Kl(e)}))}function ou(e,t){return t().catch((n=>ru(e,n,t)))}async function au(e){const t=Vr(e),n=vu(t);let i=t.Eu.length>0?t.Eu[t.Eu.length-1].batchId:-1;for(;hu(t);)try{const e=await Il(t.localStore,i);if(null===e){0===t.Eu.length&&n.jo();break}i=e.batchId,cu(t,e)}catch(e){await ru(t,e)}lu(t)&&uu(t)}function hu(e){return eu(e)&&e.Eu.length<10}function cu(e,t){e.Eu.push(t);const n=vu(e);n.Ko()&&n.ou&&n.uu(t.mutations)}function lu(e){return eu(e)&&!vu(e).Uo()&&e.Eu.length>0}function uu(e){vu(e).start()}async function du(e){vu(e).hu()}async function fu(e){const t=vu(e);for(const n of e.Eu)t.uu(n.mutations)}async function pu(e,t,n){const i=e.Eu.shift(),s=Gh.from(i,t,n);await ou(e,(()=>e.remoteSyncer.applySuccessfulWrite(s))),await au(e)}async function mu(e,t){t&&vu(e).ou&&await async function(e,t){if(Zh(n=t.code)&&n!==jr.ABORTED){const n=e.Eu.shift();vu(e).Qo(),await ou(e,(()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t))),await au(e)}var n}(e,t),lu(e)&&uu(e)}async function gu(e,t){const n=Vr(e);n.asyncQueue.verifyOperationInProgress(),Or("RemoteStore","RemoteStore received new credentials");const i=eu(n);n.vu.add(3),await Wl(n),i&&n.bu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.vu.delete(3),await Kl(n)}async function yu(e,t){const n=Vr(e);t?(n.vu.delete(2),await Kl(n)):t||(n.vu.add(2),await Wl(n),n.bu.set("Unknown"))}function wu(e){return e.Su||(e.Su=function(e,t,n){const i=Vr(e);return i.fu(),new ql(t,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,n)}(e.datastore,e.asyncQueue,{uo:nu.bind(null,e),ao:iu.bind(null,e),nu:su.bind(null,e)}),e.Ru.push((async t=>{t?(e.Su.Qo(),Zl(e)?Xl(e):e.bu.set("Unknown")):(await e.Su.stop(),tu(e))}))),e.Su}function vu(e){return e.Du||(e.Du=function(e,t,n){const i=Vr(e);return i.fu(),new Bl(t,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,n)}(e.datastore,e.asyncQueue,{uo:du.bind(null,e),ao:mu.bind(null,e),au:fu.bind(null,e),cu:pu.bind(null,e)}),e.Ru.push((async t=>{t?(e.Du.Qo(),await au(e)):(await e.Du.stop(),e.Eu.length>0&&(Or("RemoteStore",`Stopping write stream with ${e.Eu.length} pending writes`),e.Eu=[]))}))),e.Du
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tu{static emptySet(e){return new Tu(e.comparator)}has(e){return null!=this.keyedMap.get(e)}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const t=this.keyedMap.get(e);return t?this.sortedSet.indexOf(t):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal(((t,n)=>(e(t),!1)))}add(e){const t=this.delete(e.key);return t.copy(t.keyedMap.insert(e.key,e),t.sortedSet.insert(e,null))}delete(e){const t=this.get(e);return t?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(t)):this}isEqual(e){if(!(e instanceof Tu))return!1;if(this.size!==e.size)return!1;const t=this.sortedSet.getIterator(),n=e.sortedSet.getIterator();for(;t.hasNext();){const e=t.getNext().key,i=n.getNext().key;if(!e.isEqual(i))return!1}return!0}toString(){const e=[];return this.forEach((t=>{e.push(t.toString())})),0===e.length?"DocumentSet ()":"DocumentSet (\n  "+e.join("  \n")+"\n)"}copy(e,t){const n=new Tu;return n.comparator=this.comparator,n.keyedMap=e,n.sortedSet=t,n}constructor(e){this.comparator=e?(t,n)=>e(t,n)||ao.comparator(t.key,n.key):(e,t)=>ao.comparator(e.key,t.key),this.keyedMap=ah(),this.sortedSet=new No(this.comparator)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Su{constructor(){this.Nu=void 0,this.listeners=[]}}class ku{constructor(){this.queries=new ih((e=>Ya(e)),Ja),this.onlineState="Unknown",this.ku=new Set}}async function Cu(e,t){const n=Vr(e),i=t.query;let s=!1,r=n.queries.get(i);if(r||(s=!0,r=new Su),s)try{r.Nu=await n.onListen(i)}catch(e){const n=_u(e,`Initialization of query '${Xa(t.query)}' failed`);return void t.onError(n)}n.queries.set(i,r),r.listeners.push(t),t.Mu(n.onlineState),r.Nu&&t.$u(r.Nu)&&Ru(n)}async function Au(e,t){const n=Vr(e),i=t.query;let s=!1;const r=n.queries.get(i);if(r){const e=r.listeners.indexOf(t);e>=0&&(r.listeners.splice(e,1),s=0===r.listeners.length)}if(s)return n.queries.delete(i),n.onUnlisten(i)}function Nu(e,t){const n=Vr(e);let i=!1;for(const e of t){const t=e.query,s=n.queries.get(t);if(s){for(const t of s.listeners)t.$u(e)&&(i=!0);s.Nu=e}}i&&Ru(n)}function Du(e,t,n){const i=Vr(e),s=i.queries.get(t);if(s)for(const e of s.listeners)e.onError(n);i.queries.delete(t)}function Ru(e){e.ku.forEach((e=>{e.next()}))}class xu{$u(e){if(!this.options.includeMetadataChanges){const t=[];for(const n of e.docChanges)3!==n.type&&t.push(n);e=new Eu(e.query,e.docs,e.oldDocs,t,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.Fu?this.Lu(e)&&(this.Ou.next(e),t=!0):this.qu(e,this.onlineState)&&(this.Uu(e),t=!0),this.Bu=e,t}onError(e){this.Ou.error(e)}Mu(e){this.onlineState=e;let t=!1;return this.Bu&&!this.Fu&&this.qu(this.Bu,e)&&(this.Uu(this.Bu),t=!0),t}qu(e,t){if(!e.fromCache)return!0;const n="Offline"!==t;return(!this.options.Ku||!n)&&(!e.docs.isEmpty()||e.hasCachedResults||"Offline"===t)}Lu(e){if(e.docChanges.length>0)return!0;const t=this.Bu&&this.Bu.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&!0===this.options.includeMetadataChanges}Uu(e){e=Eu.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Fu=!0,this.Ou.next(e)}constructor(e,t,n){this.query=e,this.Ou=t,this.Fu=!1,this.Bu=null,this.onlineState="Unknown",this.options=n||{}}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ou{constructor(e){this.key=e}}class Lu{constructor(e){this.key=e}}class Pu{get nc(){return this.Yu}sc(e,t){const n=t?t.ic:new Iu,i=t?t.ec:this.ec;let s=t?t.mutatedKeys:this.mutatedKeys,r=i,o=!1;const a="F"===this.query.limitType&&i.size===this.query.limit?i.last():null,h="L"===this.query.limitType&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal(((e,t)=>{const c=i.get(e),l=Za(this.query,t)?t:null,u=!!c&&this.mutatedKeys.has(c.key),d=!!l&&(l.hasLocalMutations||this.mutatedKeys.has(l.key)&&l.hasCommittedMutations);let f=!1;c&&l?c.data.isEqual(l.data)?u!==d&&(n.track({type:3,doc:l}),f=!0):this.rc(c,l)||(n.track({type:2,doc:l}),f=!0,(a&&this.tc(l,a)>0||h&&this.tc(l,h)<0)&&(o=!0)):!c&&l?(n.track({type:0,doc:l}),f=!0):c&&!l&&(n.track({type:1,doc:c}),f=!0,(a||h)&&(o=!0)),f&&(l?(r=r.add(l),s=d?s.add(e):s.delete(e)):(r=r.delete(e),s=s.delete(e)))})),null!==this.query.limit)for(;r.size>this.query.limit;){const e="F"===this.query.limitType?r.last():r.first();r=r.delete(e.key),s=s.delete(e.key),n.track({type:1,doc:e})}return{ec:r,ic:n,zi:o,mutatedKeys:s}}rc(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n){const i=this.ec;this.ec=e.ec,this.mutatedKeys=e.mutatedKeys;const s=e.ic.xu();s.sort(((e,t)=>function(e,t){const n=e=>{switch(e){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return Fr()}};return n(e)-n(t)}(e.type,t.type)||this.tc(e.doc,t.doc))),this.oc(n);const r=t?this.uc():[],o=0===this.Zu.size&&this.current?1:0,a=o!==this.Xu;return this.Xu=o,0!==s.length||a?{snapshot:new Eu(this.query,e.ec,i,s,e.mutatedKeys,0===o,a,!1,!!n&&n.resumeToken.approximateByteSize()>0),cc:r}:{cc:r}}Mu(e){return this.current&&"Offline"===e?(this.current=!1,this.applyChanges({ec:this.ec,ic:new Iu,mutatedKeys:this.mutatedKeys,zi:!1},!1)):{cc:[]}}ac(e){return!this.Yu.has(e)&&!!this.ec.has(e)&&!this.ec.get(e).hasLocalMutations}oc(e){e&&(e.addedDocuments.forEach((e=>this.Yu=this.Yu.add(e))),e.modifiedDocuments.forEach((e=>{})),e.removedDocuments.forEach((e=>this.Yu=this.Yu.delete(e))),this.current=e.current)}uc(){if(!this.current)return[];const e=this.Zu;this.Zu=ph(),this.ec.forEach((e=>{this.ac(e.key)&&(this.Zu=this.Zu.add(e.key))}));const t=[];return e.forEach((e=>{this.Zu.has(e)||t.push(new Lu(e))})),this.Zu.forEach((n=>{e.has(n)||t.push(new Ou(n))})),t}hc(e){this.Yu=e.ir,this.Zu=ph();const t=this.sc(e.documents);return this.applyChanges(t,!0)}lc(){return Eu.fromInitialDocuments(this.query,this.ec,this.mutatedKeys,0===this.Xu,this.hasCachedResults)}constructor(e,t){this.query=e,this.Yu=t,this.Xu=null,this.hasCachedResults=!1,this.current=!1,this.Zu=ph(),this.mutatedKeys=ph(),this.tc=th(e),this.ec=new Tu(this.tc)}}class Mu{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class Fu{constructor(e){this.key=e,this.fc=!1}}class Uu{get isPrimaryClient(){return!0===this.vc}constructor(e,t,n,i,s,r){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=i,this.currentUser=s,this.maxConcurrentLimboResolutions=r,this.dc={},this.wc=new ih((e=>Ya(e)),Ja),this._c=new Map,this.mc=new Set,this.gc=new No(ao.comparator),this.yc=new Map,this.Ic=new al,this.Tc={},this.Ec=new Map,this.Ac=tl.Mn(),this.onlineState="Unknown",this.vc=void 0}}async function Vu(e,t){const n=id(e);let i,s;const r=n.wc.get(t);if(r)i=r.targetId,n.sharedClientState.addLocalQueryTarget(i),s=r.view.lc();else{const e=await El(n.localStore,Wa(t)),r=n.sharedClientState.addLocalQueryTarget(e.targetId);i=e.targetId,s=await ju(n,t,i,"current"===r,e.resumeToken),n.isPrimaryClient&&Gl(n.remoteStore,e)}return s}async function ju(e,t,n,i,s){e.Rc=(t,n,i)=>async function(e,t,n,i){let s=t.view.sc(n);s.zi&&(s=await kl(e.localStore,t.query,!1).then((({documents:e})=>t.view.sc(e,s))));const r=i&&i.targetChanges.get(t.targetId),o=t.view.applyChanges(s,e.isPrimaryClient,r);return Yu(e,t.targetId,o.cc),o.snapshot}(e,t,n,i);const r=await kl(e.localStore,t,!0),o=new Pu(t,r.ir),a=o.sc(r.documents),h=lc.createSynthesizedTargetChangeForCurrentChange(n,i&&"Offline"!==e.onlineState,s),c=o.applyChanges(a,e.isPrimaryClient,h);Yu(e,n,c.cc);const l=new Mu(t,n,o);return e.wc.set(t,l),e._c.has(n)?e._c.get(n).push(t):e._c.set(n,[t]),c.snapshot}async function qu(e,t){const n=Vr(e),i=n.wc.get(t),s=n._c.get(i.targetId);if(s.length>1)return n._c.set(i.targetId,s.filter((e=>!Ja(e,t)))),void n.wc.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(i.targetId),n.sharedClientState.isActiveQueryTarget(i.targetId)||await Sl(n.localStore,i.targetId,!1).then((()=>{n.sharedClientState.clearQueryState(i.targetId),Ql(n.remoteStore,i.targetId),Qu(n,i.targetId)})).catch(go)):(Qu(n,i.targetId),await Sl(n.localStore,i.targetId,!0))}async function Bu(e,t){const n=Vr(e);try{const e=await function(e,t){const n=Vr(e),i=t.snapshotVersion;let s=n.Ji;return n.persistence.runTransaction("Apply remote event","readwrite-primary",(e=>{const r=n.Zi.newChangeBuffer({trackRemovals:!0});s=n.Ji;const o=[];t.targetChanges.forEach(((r,a)=>{const h=s.get(a);if(!h)return;o.push(n.Bs.removeMatchingKeys(e,r.removedDocuments,a).next((()=>n.Bs.addMatchingKeys(e,r.addedDocuments,a))));let c=h.withSequenceNumber(e.currentSequenceNumber);var l,u,d;null!==t.targetMismatches.get(a)?c=c.withResumeToken(Fo.EMPTY_BYTE_STRING,no.min()).withLastLimboFreeSnapshotVersion(no.min()):r.resumeToken.approximateByteSize()>0&&(c=c.withResumeToken(r.resumeToken,i)),s=s.insert(a,c),u=c,d=r,(0===(l=h).resumeToken.approximateByteSize()||u.snapshotVersion.toMicroseconds()-l.snapshotVersion.toMicroseconds()>=3e8||d.addedDocuments.size+d.modifiedDocuments.size+d.removedDocuments.size>0)&&o.push(n.Bs.updateTargetData(e,c))}));let a=rh(),h=ph();if(t.documentUpdates.forEach((i=>{t.resolvedLimboDocuments.has(i)&&o.push(n.persistence.referenceDelegate.updateLimboDocument(e,i))})),o.push(Tl(e,r,t.documentUpdates).next((e=>{a=e.nr,h=e.sr}))),!i.isEqual(no.min())){const t=n.Bs.getLastRemoteSnapshotVersion(e).next((t=>n.Bs.setTargetsMetadata(e,e.currentSequenceNumber,i)));o.push(t)}return yo.waitFor(o).next((()=>r.apply(e))).next((()=>n.localDocuments.getLocalViewOfDocuments(e,a,h))).next((()=>a))})).then((e=>(n.Ji=s,e)))}(n.localStore,t);t.targetChanges.forEach(((e,t)=>{const i=n.yc.get(t);i&&(Ur(e.addedDocuments.size+e.modifiedDocuments.size+e.removedDocuments.size<=1),e.addedDocuments.size>0?i.fc=!0:e.modifiedDocuments.size>0?Ur(i.fc):e.removedDocuments.size>0&&(Ur(i.fc),i.fc=!1))})),await ed(n,e,t)}catch(e){await go(e)}}function Hu(e,t,n){const i=Vr(e);if(i.isPrimaryClient&&0===n||!i.isPrimaryClient&&1===n){const e=[];i.wc.forEach(((n,i)=>{const s=i.view.Mu(t);s.snapshot&&e.push(s.snapshot)})),function(e,t){const n=Vr(e);n.onlineState=t;let i=!1;n.queries.forEach(((e,n)=>{for(const e of n.listeners)e.Mu(t)&&(i=!0)})),i&&Ru(n)}(i.eventManager,t),e.length&&i.dc.nu(e),i.onlineState=t,i.isPrimaryClient&&i.sharedClientState.setOnlineState(t)}}async function zu(e,t,n){const i=Vr(e);i.sharedClientState.updateQueryState(t,"rejected",n);const s=i.yc.get(t),r=s&&s.key;if(r){let e=new No(ao.comparator);e=e.insert(r,ua.newNoDocument(r,no.min()));const n=ph().add(r),s=new cc(no.min(),new Map,new No(Zr),e,n);await Bu(i,s),i.gc=i.gc.remove(r),i.yc.delete(t),Zu(i)}else await Sl(i.localStore,t,!1).then((()=>Qu(i,t,n))).catch(go)}async function $u(e,t){const n=Vr(e),i=t.batch.batchId;try{const e=await function(e,t){const n=Vr(e);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",(e=>{const i=t.batch.keys(),s=n.Zi.newChangeBuffer({trackRemovals:!0});return function(e,t,n,i){const s=n.batch,r=s.keys();let o=yo.resolve();return r.forEach((e=>{o=o.next((()=>i.getEntry(t,e))).next((t=>{const r=n.docVersions.get(e);Ur(null!==r),t.version.compareTo(r)<0&&(s.applyToRemoteDocument(t,n),t.isValidDocument()&&(t.setReadTime(n.commitVersion),i.addEntry(t)))}))})),o.next((()=>e.mutationQueue.removeMutationBatch(t,s)))}(n,e,t,s).next((()=>s.apply(e))).next((()=>n.mutationQueue.performConsistencyCheck(e))).next((()=>n.documentOverlayCache.removeOverlaysForBatchId(e,i,t.batch.batchId))).next((()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,function(e){let t=ph();for(let n=0;n<e.mutationResults.length;++n)e.mutationResults[n].transformResults.length>0&&(t=t.add(e.batch.mutations[n].key));return t}(t)))).next((()=>n.localDocuments.getDocuments(e,i)))}))}(n.localStore,t);Gu(n,i,null),Wu(n,i),n.sharedClientState.updateMutationState(i,"acknowledged"),await ed(n,e)}catch(e){await go(e)}}async function Ku(e,t,n){const i=Vr(e);try{const e=await function(e,t){const n=Vr(e);return n.persistence.runTransaction("Reject batch","readwrite-primary",(e=>{let i;return n.mutationQueue.lookupMutationBatch(e,t).next((t=>(Ur(null!==t),i=t.keys(),n.mutationQueue.removeMutationBatch(e,t)))).next((()=>n.mutationQueue.performConsistencyCheck(e))).next((()=>n.documentOverlayCache.removeOverlaysForBatchId(e,i,t))).next((()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,i))).next((()=>n.localDocuments.getDocuments(e,i)))}))}(i.localStore,t);Gu(i,t,n),Wu(i,t),i.sharedClientState.updateMutationState(t,"rejected",n),await ed(i,e)}catch(e){await go(e)}}function Wu(e,t){(e.Ec.get(t)||[]).forEach((e=>{e.resolve()})),e.Ec.delete(t)}function Gu(e,t,n){const i=Vr(e);let s=i.Tc[i.currentUser.toKey()];if(s){const e=s.get(t);e&&(n?e.reject(n):e.resolve(),s=s.remove(t)),i.Tc[i.currentUser.toKey()]=s}}function Qu(e,t,n=null){e.sharedClientState.removeLocalQueryTarget(t);for(const i of e._c.get(t))e.wc.delete(i),n&&e.dc.Pc(i,n);e._c.delete(t),e.isPrimaryClient&&e.Ic.Is(t).forEach((t=>{e.Ic.containsKey(t)||Ju(e,t)}))}function Ju(e,t){e.mc.delete(t.path.canonicalString());const n=e.gc.get(t);null!==n&&(Ql(e.remoteStore,n),e.gc=e.gc.remove(t),e.yc.delete(n),Zu(e))}function Yu(e,t,n){for(const i of n)i instanceof Ou?(e.Ic.addReference(i.key,t),Xu(e,i)):i instanceof Lu?(Or("SyncEngine","Document no longer in limbo: "+i.key),e.Ic.removeReference(i.key,t),e.Ic.containsKey(i.key)||Ju(e,i.key)):Fr()}function Xu(e,t){const n=t.key,i=n.path.canonicalString();e.gc.get(n)||e.mc.has(i)||(Or("SyncEngine","New document in limbo: "+n),e.mc.add(i),Zu(e))}function Zu(e){for(;e.mc.size>0&&e.gc.size<e.maxConcurrentLimboResolutions;){const t=e.mc.values().next().value;e.mc.delete(t);const n=new ao(so.fromString(t)),i=e.Ac.next();e.yc.set(i,new Fu(n)),e.gc=e.gc.insert(n,i),Gl(e.remoteStore,new Gc(Wa(qa(n.path)),i,"TargetPurposeLimboResolution",vo.ct))}}async function ed(e,t,n){const i=Vr(e),s=[],r=[],o=[];i.wc.isEmpty()||(i.wc.forEach(((e,a)=>{o.push(i.Rc(a,t,n).then((e=>{if((e||n)&&i.isPrimaryClient&&i.sharedClientState.updateQueryState(a.targetId,(null==e?void 0:e.fromCache)?"not-current":"current"),e){s.push(e);const t=gl.Li(a.targetId,e);r.push(t)}})))})),await Promise.all(o),i.dc.nu(s),await async function(e,t){const n=Vr(e);try{await n.persistence.runTransaction("notifyLocalViewChanges","readwrite",(e=>yo.forEach(t,(t=>yo.forEach(t.Fi,(i=>n.persistence.referenceDelegate.addReference(e,t.targetId,i))).next((()=>yo.forEach(t.Bi,(i=>n.persistence.referenceDelegate.removeReference(e,t.targetId,i)))))))))}catch(e){if(!wo(e))throw e;Or("LocalStore","Failed to update sequence numbers: "+e)}for(const e of t){const t=e.targetId;if(!e.fromCache){const e=n.Ji.get(t),i=e.snapshotVersion,s=e.withLastLimboFreeSnapshotVersion(i);n.Ji=n.Ji.insert(t,s)}}}(i.localStore,r))}async function td(e,t){const n=Vr(e);if(!n.currentUser.isEqual(t)){Or("SyncEngine","User change. New user:",t.toKey());const e=await bl(n.localStore,t);n.currentUser=t,(i=n).Ec.forEach((e=>{e.forEach((e=>{e.reject(new qr(jr.CANCELLED,"'waitForPendingWrites' promise is rejected due to a user change."))}))})),i.Ec.clear(),n.sharedClientState.handleUserChange(t,e.removedBatchIds,e.addedBatchIds),await ed(n,e.er)}var i}function nd(e,t){const n=Vr(e),i=n.yc.get(t);if(i&&i.fc)return ph().add(i.key);{let e=ph();const i=n._c.get(t);if(!i)return e;for(const t of i){const i=n.wc.get(t);e=e.unionWith(i.view.nc)}return e}}function id(e){const t=Vr(e);return t.remoteStore.remoteSyncer.applyRemoteEvent=Bu.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=nd.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=zu.bind(null,t),t.dc.nu=Nu.bind(null,t.eventManager),t.dc.Pc=Du.bind(null,t.eventManager),t}function sd(e){const t=Vr(e);return t.remoteStore.remoteSyncer.applySuccessfulWrite=$u.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=Ku.bind(null,t),t}class rd{async initialize(e){this.serializer=Ul(e.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(e),this.persistence=this.createPersistence(e),await this.persistence.start(),this.localStore=this.createLocalStore(e),this.gcScheduler=this.createGarbageCollectionScheduler(e,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(e,this.localStore)}createGarbageCollectionScheduler(e,t){return null}createIndexBackfillerScheduler(e,t){return null}createLocalStore(e){return vl(this.persistence,new yl,e.initialUser,this.serializer)}createPersistence(e){return new fl(ml.zs,this.serializer)}createSharedClientState(e){return new Nl}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}constructor(){this.synchronizeTabs=!1}}class od{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=e=>Hu(this.syncEngine,e,1),this.remoteStore.remoteSyncer.handleCredentialChange=td.bind(null,this.syncEngine),await yu(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new ku}createDatastore(e){const t=Ul(e.databaseInfo.databaseId),n=(i=e.databaseInfo,new Ml(i));var i,s,r;return s=e.authCredentials,r=e.appCheckCredentials,new Hl(s,r,n,t)}createRemoteStore(e){var t,n,i,s,r;return t=this.localStore,n=this.datastore,i=e.asyncQueue,s=e=>Hu(this.syncEngine,e,0),r=Rl.D()?new Rl:new Dl,new $l(t,n,i,s,r)}createSyncEngine(e,t){return function(e,t,n,i,s,r,o){const a=new Uu(e,t,n,i,s,r);return o&&(a.vc=!0),a}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}terminate(){return async function(e){const t=Vr(e);Or("RemoteStore","RemoteStore shutting down."),t.vu.add(5),await Wl(t),t.Pu.shutdown(),t.bu.set("Unknown")}(this.remoteStore)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ed{isEqual(e){var t,n;return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&(t=this.experimentalLongPollingOptions,n=e.experimentalLongPollingOptions,t.timeoutSeconds===n.timeoutSeconds)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}constructor(e){var t,n;if(void 0===e.host){if(void 0!==e.ssl)throw new qr(jr.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=null===(t=e.ssl)||void 0===t||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.cache=e.localCache,void 0===e.cacheSizeBytes)this.cacheSizeBytes=41943040;else{if(-1!==e.cacheSizeBytes&&e.cacheSizeBytes<1048576)throw new qr(jr.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}(function(e,t,n,i){if(!0===t&&!0===i)throw new qr(jr.INVALID_ARGUMENT,`${e} and ${n} cannot be used together.`)})("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:void 0===e.experimentalAutoDetectLongPolling?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=yd(null!==(n=e.experimentalLongPollingOptions)&&void 0!==n?n:{}),function(e){if(void 0!==e.timeoutSeconds){if(isNaN(e.timeoutSeconds))throw new qr(jr.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (must not be NaN)`);if(e.timeoutSeconds<5)throw new qr(jr.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (minimum allowed value is 5)`);if(e.timeoutSeconds>30)throw new qr(jr.INVALID_ARGUMENT,`invalid long polling timeout: ${e.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}}class Sd{get app(){if(!this._app)throw new qr(jr.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return void 0!==this._terminateTask}_setSettings(e){if(this._settingsFrozen)throw new qr(jr.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Ed(e),void 0!==e.credentials&&(this._authCredentials=function(e){if(!e)return new zr;switch(e.type){case"firstParty":return new Gr(e.sessionIndex||"0",e.iamToken||null,e.authTokenFactory||null);case"provider":return e.client;default:throw new qr(jr.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(e){const t=wd.get(e);t&&(Or("ComponentProvider","Removing Datastore"),wd.delete(e),t.terminate())}(this),Promise.resolve()}constructor(e,t,n,i){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=n,this._app=i,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Ed({}),this._settingsFrozen=!1}}function kd(e,t,n,i={}){var s;const r=(e=Id(e,Sd))._getSettings();if("firestore.googleapis.com"!==r.host&&r.host!==t&&Pr("Host has been set in both settings() and useEmulator(), emulator host will be used"),e._setSettings(Object.assign(Object.assign({},r),{host:`${t}:${n}`,ssl:!1})),i.mockUserToken){let t,n;if("string"==typeof i.mockUserToken)t=i.mockUserToken,n=Nr.MOCK_USER;else{t=$(i.mockUserToken,null===(s=e._app)||void 0===s?void 0:s.options.projectId);const r=i.mockUserToken.sub||i.mockUserToken.user_id;if(!r)throw new qr(jr.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");n=new Nr(r)}e._authCredentials=new $r(new Hr(t,n))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cd{get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Nd(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Cd(this.firestore,e,this._key)}constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}}class Ad{withConverter(e){return new Ad(this.firestore,e,this._query)}constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}}class Nd extends Ad{get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Cd(this.firestore,null,new ao(e))}withConverter(e){return new Nd(this.firestore,e,this._path)}constructor(e,t,n){super(e,t,qa(n)),this._path=n,this.type="collection"}}function Dd(e,t,...n){if(e=he(e),vd("collection","path",t),e instanceof Sd){const i=so.fromString(t,...n);return _d(i),new Nd(e,null,i)}{if(!(e instanceof Cd||e instanceof Nd))throw new qr(jr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=e._path.child(so.fromString(t,...n));return _d(i),new Nd(e.firestore,null,i)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Md{static fromBase64String(e){try{return new Md(Fo.fromBase64String(e))}catch(e){throw new qr(jr.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new Md(Fo.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}constructor(e){this._byteString=e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fd{isEqual(e){return this._internalPath.isEqual(e._internalPath)}constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new qr(jr.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new oo(e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vd{get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Zr(this._lat,e._lat)||Zr(this._long,e._long)}constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new qr(jr.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new qr(jr.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jd=/^__.*__$/;class qd{toMutation(e,t){return null!==this.fieldMask?new qh(e,this.data,this.fieldMask,t,this.fieldTransforms):new jh(e,this.data,t,this.fieldTransforms)}constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}}function Bd(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Fr()}}class Hd{get path(){return this.settings.path}get ca(){return this.settings.ca}aa(e){return new Hd(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ha(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),i=this.aa({path:n,la:!1});return i.fa(e),i}da(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),i=this.aa({path:n,la:!1});return i.ua(),i}wa(e){return this.aa({path:void 0,la:!0})}_a(e){return tf(e,this.settings.methodName,this.settings.ma||!1,this.path,this.settings.ga)}contains(e){return void 0!==this.fieldMask.find((t=>e.isPrefixOf(t)))||void 0!==this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))}ua(){if(this.path)for(let e=0;e<this.path.length;e++)this.fa(this.path.get(e))}fa(e){if(0===e.length)throw this._a("Document fields must not be empty");if(Bd(this.ca)&&jd.test(e))throw this._a('Document fields cannot begin and end with "__"')}constructor(e,t,n,i,s,r){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=i,void 0===s&&this.ua(),this.fieldTransforms=s||[],this.fieldMask=r||[]}}class zd{ya(e,t,n,i=!1){return new Hd({ca:e,methodName:t,ga:n,path:oo.emptyPath(),la:!1,ma:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||Ul(e)}}function $d(e){const t=e._freezeSettings(),n=Ul(e._databaseId);return new zd(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Kd(e,t,n,i,s,r={}){const o=e.ya(r.merge||r.mergeFields?2:0,t,n,s);Yd("Data must be an object, but it was:",o,i);const a=Qd(i,o);let h,c;if(r.merge)h=new Lo(o.fieldMask),c=o.fieldTransforms;else if(r.mergeFields){const e=[];for(const i of r.mergeFields){const s=Xd(t,i,n);if(!o.contains(s))throw new qr(jr.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);nf(e,s)||e.push(s)}h=new Lo(e),c=o.fieldTransforms.filter((e=>h.covers(e.field)))}else h=null,c=o.fieldTransforms;return new qd(new ca(a),h,c)}function Wd(e,t,n,i=!1){return Gd(n,e.ya(i?4:3,t))}function Gd(e,t){if(Jd(e=he(e)))return Yd("Unsupported field value:",t,e),Qd(e,t);if(e instanceof Ud)return function(e,t){if(!Bd(t.ca))throw t._a(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t._a(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.la&&4!==t.ca)throw t._a("Nested arrays are not supported");return function(e,t){const n=[];let i=0;for(const s of e){let e=Gd(s,t.wa(i));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),i++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=he(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return vh(t.serializer,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=to.fromDate(e);return{timestampValue:Ic(t.serializer,n)}}if(e instanceof to){const n=new to(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:Ic(t.serializer,n)}}if(e instanceof Vd)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof Md)return{bytesValue:Ec(t.serializer,e._byteString)};if(e instanceof Cd){const n=t.databaseId,i=e.firestore._databaseId;if(!i.isEqual(n))throw t._a(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:Cc(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t._a(`Unsupported field value: ${Td(e)}`)}(e,t)}function Qd(e,t){const n={};return Ao(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Co(e,((e,i)=>{const s=Gd(i,t.ha(e));null!=s&&(n[e]=s)})),{mapValue:{fields:n}}}function Jd(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof to||e instanceof Vd||e instanceof Md||e instanceof Cd||e instanceof Ud)}function Yd(e,t,n){if(!Jd(n)||("object"!=typeof(i=n)||null===i||Object.getPrototypeOf(i)!==Object.prototype&&null!==Object.getPrototypeOf(i))){const i=Td(n);throw"an object"===i?t._a(e+" a custom object"):t._a(e+" "+i)}var i}function Xd(e,t,n){if((t=he(t))instanceof Fd)return t._internalPath;if("string"==typeof t)return ef(e,t);throw tf("Field path arguments must be of type string or ",e,!1,void 0,n)}const Zd=new RegExp("[~\\*/\\[\\]]");function ef(e,t,n){if(t.search(Zd)>=0)throw tf(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new Fd(...t.split("."))._internalPath}catch(i){throw tf(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function tf(e,t,n,i,s){const r=i&&!i.isEmpty(),o=void 0!==s;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let h="";return(r||o)&&(h+=" (found",r&&(h+=` in field ${i}`),o&&(h+=` in document ${s}`),h+=")"),new qr(jr.INVALID_ARGUMENT,a+e+h)}function nf(e,t){return e.some((e=>e.isEqual(t)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function af(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new qr(jr.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class hf{}class cf extends hf{}function lf(e,t,...n){let i=[];t instanceof hf&&i.push(t),i=i.concat(n),function(e){const t=e.filter((e=>e instanceof ff)).length,n=e.filter((e=>e instanceof uf)).length;if(t>1||t>0&&n>0)throw new qr(jr.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(i);for(const t of i)e=t._apply(e);return e}class uf extends cf{static _create(e,t,n){return new uf(e,t,n)}_apply(e){const t=this._parse(e);return gf(e._query,t),new Ad(e.firestore,e.converter,Ga(e._query,t))}_parse(e){const t=$d(e.firestore);return function(e,t,n,i,s,r,o){let a;if(s.isKeyField()){if("array-contains"===r||"array-contains-any"===r)throw new qr(jr.INVALID_ARGUMENT,`Invalid Query. You can't perform '${r}' queries on documentId().`);if("in"===r||"not-in"===r){mf(o,r);const t=[];for(const n of o)t.push(pf(i,e,n));a={arrayValue:{values:t}}}else a=pf(i,e,o)}else"in"!==r&&"not-in"!==r&&"array-contains-any"!==r||mf(o,r),a=Wd(n,"where",o,"in"===r||"not-in"===r);return wa.create(s,r,a)}(e._query,0,t,e.firestore._databaseId,this._field,this._op,this._value)}constructor(e,t,n){super(),this._field=e,this._op=t,this._value=n,this.type="where"}}function df(e,t,n){const i=t,s=of("where",e);return uf._create(s,i,n)}class ff extends hf{static _create(e,t){return new ff(e,t)}_parse(e){const t=this._queryConstraints.map((t=>t._parse(e))).filter((e=>e.getFilters().length>0));return 1===t.length?t[0]:va.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return 0===t.getFilters().length?e:(function(e,t){let n=e;const i=t.getFlattenedFilters();for(const e of i)gf(n,e),n=Ga(n,e)}(e._query,t),new Ad(e.firestore,e.converter,Ga(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return"and"===this.type?"and":"or"}constructor(e,t){super(),this.type=e,this._queryConstraints=t}}function pf(e,t,n){if("string"==typeof(n=he(n))){if(""===n)throw new qr(jr.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!$a(t)&&-1!==n.indexOf("/"))throw new qr(jr.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const i=t.path.child(so.fromString(n));if(!ao.isDocumentKey(i))throw new qr(jr.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${i}' is not because it has an odd number of segments (${i.length}).`);return ta(e,new ao(i))}if(n instanceof Cd)return ta(e,n._key);throw new qr(jr.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Td(n)}.`)}function mf(e,t){if(!Array.isArray(e)||0===e.length)throw new qr(jr.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function gf(e,t){if(t.isInequality()){const n=za(e),i=t.field;if(null!==n&&!n.isEqual(i))throw new qr(jr.INVALID_ARGUMENT,`Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${i.toString()}'`);const s=Ha(e);null!==s&&yf(e,i,s)}const n=function(e,t){for(const n of e)for(const e of n.getFlattenedFilters())if(t.indexOf(e.op)>=0)return e.op;return null}(e.filters,function(e){switch(e){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(null!==n)throw n===t.op?new qr(jr.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new qr(jr.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${n.toString()}' filters.`)}function yf(e,t,n){if(!n.isEqual(t))throw new qr(jr.INVALID_ARGUMENT,`Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${t.toString()}' and so you must also use '${t.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`)}class wf{convertValue(e,t="none"){switch(Go(e)){case 0:return null;case 1:return e.booleanValue;case 2:return jo(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(qo(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 10:return this.convertObject(e.mapValue,t);default:throw Fr()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const n={};return Co(e,((e,i)=>{n[e]=this.convertValue(i,t)})),n}convertGeoPoint(e){return new Vd(jo(e.latitude),jo(e.longitude))}convertArray(e,t){return(e.values||[]).map((e=>this.convertValue(e,t)))}convertServerTimestamp(e,t){switch(t){case"previous":const n=Ho(e);return null==n?null:this.convertValue(n,t);case"estimate":return this.convertTimestamp(zo(e));default:return null}}convertTimestamp(e){const t=Vo(e);return new to(t.seconds,t.nanos)}convertDocumentKey(e,t){const n=so.fromString(e);Ur(Wc(n));const i=new Ko(n.get(1),n.get(3)),s=new ao(n.popFirst(5));return i.isEqual(t)||Lr(`Document ${s} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),s}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class bf{isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}}class _f extends sf{exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new Tf(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(of("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}constructor(e,t,n,i,s,r){super(e,t,n,i,r),this._firestore=e,this._firestoreImpl=e,this.metadata=s}}class Tf extends _f{data(e={}){return super.data(e)}}class If{get docs(){const e=[];return this.forEach((t=>e.push(t))),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach((n=>{e.call(t,new Tf(this._firestore,this._userDataWriter,n.key,n,new bf(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new qr(jr.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map((n=>{const i=new Tf(e._firestore,e._userDataWriter,n.doc.key,n.doc,new bf(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:i,oldIndex:-1,newIndex:t++}}))}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter((e=>t||3!==e.type)).map((t=>{const i=new Tf(e._firestore,e._userDataWriter,t.doc.key,t.doc,new bf(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter);let s=-1,r=-1;return 0!==t.type&&(s=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(n=n.add(t.doc),r=n.indexOf(t.doc.key)),{type:Ef(t.type),doc:i,oldIndex:s,newIndex:r}}))}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}constructor(e,t,n,i){this._firestore=e,this._userDataWriter=t,this._snapshot=i,this.metadata=new bf(i.hasPendingWrites,i.fromCache),this.query=n}}function Ef(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Fr()}}class Sf extends wf{convertBytes(e){return new Md(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Cd(this.firestore,null,t)}constructor(e){super(),this.firestore=e}}function kf(e){e=Id(e,Ad);const t=Id(e.firestore,xd),n=Ld(t),i=new Sf(t);return af(e._query),gd(n,e._query).then((n=>new If(t,i,e,n)))}function Cf(e,t){const n=Id(e.firestore,xd),i=function(e,t,...n){if(e=he(e),1===arguments.length&&(t=Xr.A()),vd("doc","path",t),e instanceof Sd){const i=so.fromString(t,...n);return bd(i),new Cd(e,null,new ao(i))}{if(!(e instanceof Cd||e instanceof Nd))throw new qr(jr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=e._path.child(so.fromString(t,...n));return bd(i),new Cd(e.firestore,e instanceof Nd?e.converter:null,new ao(i))}}(e),s=vf(e.converter,t);return Af(n,[Kd($d(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,xh.exists(!1))]).then((()=>i))}function Af(e,t){return function(e,t){const n=new Br;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){const i=sd(e);try{const e=await function(e,t){const n=Vr(e),i=to.now(),s=t.reduce(((e,t)=>e.add(t.key)),ph());let r,o;return n.persistence.runTransaction("Locally write mutations","readwrite",(e=>{let a=rh(),h=ph();return n.Zi.getEntries(e,s).next((e=>{a=e,a.forEach(((e,t)=>{t.isValidDocument()||(h=h.add(e))}))})).next((()=>n.localDocuments.getOverlayedDocuments(e,a))).next((s=>{r=s;const o=[];for(const e of t){const t=Uh(e,r.get(e.key).overlayedDocument);null!=t&&o.push(new qh(e.key,t,la(t.value.mapValue),xh.exists(!0)))}return n.mutationQueue.addMutationBatch(e,i,o,t)})).next((t=>{o=t;const i=t.applyToLocalDocumentSet(r,h);return n.documentOverlayCache.saveOverlays(e,t.batchId,i)}))})).then((()=>({batchId:o.batchId,changes:hh(r)})))}(i.localStore,t);i.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let i=e.Tc[e.currentUser.toKey()];i||(i=new No(Zr)),i=i.insert(t,n),e.Tc[e.currentUser.toKey()]=i}(i,e.batchId,n),await ed(i,e.changes),await au(i.remoteStore)}catch(e){const t=_u(e,"Failed to persist write");n.reject(t)}}(await pd(e),t,n))),n.promise}(Ld(e),t)}!function(e,t=!0){Dr="9.22.0",He(new ce("firestore",((e,{instanceIdentifier:n,options:i})=>{const s=e.getProvider("app").getImmediate(),r=new xd(new Kr(e.getProvider("auth-internal")),new Jr(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new qr(jr.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ko(e.options.projectId,t)}(s,n),s);return i=Object.assign({useFetchStreams:t},i),r._setSettings(i),r}),"PUBLIC").setMultipleInstances(!0)),Qe("@firebase/firestore","3.12.0",e),Qe("@firebase/firestore","3.12.0","esm2017")}();function Nf(e,t){var n={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(n[i]=e[i]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var s=0;for(i=Object.getOwnPropertySymbols(e);s<i.length;s++)t.indexOf(i[s])<0&&Object.prototype.propertyIsEnumerable.call(e,i[s])&&(n[i[s]]=e[i[s]])}return n}Object.create;Object.create;function Df(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Rf=Df,xf=new Y("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),Of=new ve("@firebase/auth");function Lf(e,...t){Of.logLevel<=fe.ERROR&&Of.error(`Auth (9.22.0): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pf(e,...t){throw Uf(e,...t)}function Mf(e,...t){return Uf(e,...t)}function Ff(e,t,n){const i=Object.assign(Object.assign({},Rf()),{[t]:n});return new Y("auth","Firebase",i).create(t,{appName:e.name})}function Uf(e,...t){if("string"!=typeof e){const n=t[0],i=[...t.slice(1)];return i[0]&&(i[0].appName=e.name),e._errorFactory.create(n,...i)}return xf.create(e,...t)}function Vf(e,t,...n){if(!e)throw Uf(t,...n)}function jf(e){const t="INTERNAL ASSERTION FAILED: "+e;throw Lf(t),new Error(t)}function qf(e,t){e||jf(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bf(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.href)||""}function Hf(){return"http:"===zf()||"https:"===zf()}function zf(){var e;return"undefined"!=typeof self&&(null===(e=self.location)||void 0===e?void 0:e.protocol)||null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $f(){return!("undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(Hf()||W()||"connection"in navigator))||navigator.onLine}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wf(e,t){qf(e.emulator,"Emulator should always be set here");const{url:n}=e.emulator;return t?`${n}${t.startsWith("/")?t.slice(1):t}`:n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yf(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function Xf(e,t,n,i,s={}){return Zf(e,s,(async()=>{let s={},r={};i&&("GET"===t?r=i:s={body:JSON.stringify(i)});const o=ne(Object.assign({key:e.config.apiKey},r)).slice(1),a=await e._getAdditionalHeaders();return a["Content-Type"]="application/json",e.languageCode&&(a["X-Firebase-Locale"]=e.languageCode),Gf.fetch()(tp(e,e.config.apiHost,n,o),Object.assign({method:t,headers:a,referrerPolicy:"no-referrer"},s))}))}async function Zf(e,t,n){e._canInitEmulator=!1;const i=Object.assign(Object.assign({},Qf),t);try{const t=new np(e),s=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const r=await s.json();if("needConfirmation"in r)throw ip(e,"account-exists-with-different-credential",r);if(s.ok&&!("errorMessage"in r))return r;{const t=s.ok?r.errorMessage:r.error.message,[n,o]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw ip(e,"credential-already-in-use",r);if("EMAIL_EXISTS"===n)throw ip(e,"email-already-in-use",r);if("USER_DISABLED"===n)throw ip(e,"user-disabled",r);const a=i[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(o)throw Ff(e,a,o);Pf(e,a)}}catch(t){if(t instanceof J)throw t;Pf(e,"network-request-failed",{message:String(t)})}}async function ep(e,t,n,i,s={}){const r=await Xf(e,t,n,i,s);return"mfaPendingCredential"in r&&Pf(e,"multi-factor-auth-required",{_serverResponse:r}),r}function tp(e,t,n,i){const s=`${t}${n}?${i}`;return e.config.emulator?Wf(e.config,s):`${e.config.apiScheme}://${s}`}class np{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(Mf(this.auth,"network-request-failed"))),Jf.get())}))}}function ip(e,t,n){const i={appName:e.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const s=Mf(e,t,i);return s.customData._tokenResponse=n,s}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function ap(e,t,n=!1){if(n)return t;try{return await t}catch(t){throw t instanceof J&&function({code:e}){return"auth/user-disabled"===e||"auth/user-token-expired"===e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class up{get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Vf(e.idToken,"internal-error"),Vf(void 0!==e.idToken,"internal-error"),Vf(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=op(e);return Vf(t,"internal-error"),Vf(void 0!==t.exp,"internal-error"),Vf(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return Vf(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:s}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bp(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Ep(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(_p(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(kp(t))return"Blackberry";if(Cp(t))return"Webos";if(Tp(t))return"Safari";if((t.includes("chrome/")||Ip(t))&&!t.includes("edge/"))return"Chrome";if(Sp(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function _p(e=K()){return/firefox\//i.test(e)}function Tp(e=K()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Ip(e=K()){return/crios\//i.test(e)}function Ep(e=K()){return/iemobile/i.test(e)}function Sp(e=K()){return/android/i.test(e)}function kp(e=K()){return/blackberry/i.test(e)}function Cp(e=K()){return/webos/i.test(e)}function Ap(e=K()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Np(){return G()&&10===document.documentMode}function Dp(e=K()){return Ap(e)||Sp(e)||Cp(e)||kp(e)||/windows phone/i.test(e)||Ep(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Rp(e,t=[]){let n;switch(e){case"Browser":n=bp(K());break;case"Worker":n=`${bp(K())}-${e}`;break;default:n=e}return`${n}/JsCore/9.22.0/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xp(e,t){return Xf(e,"GET","/v2/recaptchaConfig",Yf(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hp(e,t,n){const i=qp(e);Vf(i._canInitEmulator,i,"emulator-config-failed"),Vf(/^https?:\/\//.test(t),i,"invalid-emulator-scheme");const s=!!(null==n?void 0:n.disableWarnings),r=zp(t),{host:o,port:a}=function(e){const t=zp(e),n=/(\/\/)?([^?#/]+)/.exec(e.substr(t.length));if(!n)return{host:"",port:null};const i=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const e=s[1];return{host:e,port:$p(i.substr(e.length+1))}}{const[e,t]=i.split(":");return{host:e,port:$p(t)}}}(t),h=null===a?"":`:${a}`;i.config.emulator={url:`${r}//${o}${h}/`},i.settings.appVerificationDisabledForTesting=!0,i.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||function(){function e(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}"undefined"!=typeof console&&"function"==typeof console.info&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials.");"undefined"!=typeof window&&"undefined"!=typeof document&&("loading"===document.readyState?window.addEventListener("DOMContentLoaded",e):e())}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */()}function zp(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function $p(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class Kp{toJSON(){return jf("not implemented")}_getIdTokenResponse(e){return jf("not implemented")}_linkToIdToken(e,t){return jf("not implemented")}_getReauthenticationResolver(e){return jf("not implemented")}constructor(e,t){this.providerId=e,this.signInMethod=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wp(e,t){return Xf(e,"POST","/v1/accounts:update",t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Gp(e,t){return ep(e,"POST","/v1/accounts:signInWithPassword",Yf(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
return async function(e,t){return ep(e,"POST","/v1/accounts:signInWithEmailLink",Yf(e,t))}(e,{email:this._email,oobCode:this._password});default:Pf(e,"internal-error")}}async _linkToIdToken(e,t){switch(this.signInMethod){case"password":return Wp(e,{idToken:t,returnSecureToken:!0,email:this._email,password:this._password});case"emailLink":return async function(e,t){return ep(e,"POST","/v1/accounts:signInWithEmailLink",Yf(e,t))}(e,{idToken:t,email:this._email,oobCode:this._password});default:Pf(e,"internal-error")}}_getReauthenticationResolver(e){return this._getIdTokenResponse(e)}constructor(e,t,n,i=null){super("password",n),this._email=e,this._password=t,this._tenantId=i}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jp(e,t){return ep(e,"POST","/v1/accounts:signInWithIdp",Yf(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yp extends Kp{static _fromParams(e){const t=new Yp(e.providerId,e.signInMethod);return e.idToken||e.accessToken?(e.idToken&&(t.idToken=e.idToken),e.accessToken&&(t.accessToken=e.accessToken),e.nonce&&!e.pendingToken&&(t.nonce=e.nonce),e.pendingToken&&(t.pendingToken=e.pendingToken)):e.oauthToken&&e.oauthTokenSecret?(t.accessToken=e.oauthToken,t.secret=e.oauthTokenSecret):Pf("argument-error"),t}toJSON(){return{idToken:this.idToken,accessToken:this.accessToken,secret:this.secret,nonce:this.nonce,pendingToken:this.pendingToken,providerId:this.providerId,signInMethod:this.signInMethod}}static fromJSON(e){const t="string"==typeof e?JSON.parse(e):e,{providerId:n,signInMethod:i}=t,s=Nf(t,["providerId","signInMethod"]);if(!n||!i)return null;const r=new Yp(n,i);return r.idToken=s.idToken||void 0,r.accessToken=s.accessToken||void 0,r.secret=s.secret,r.nonce=s.nonce,r.pendingToken=s.pendingToken||null,r}_getIdTokenResponse(e){return Jp(e,this.buildRequest())}_linkToIdToken(e,t){const n=this.buildRequest();return n.idToken=t,Jp(e,n)}_getReauthenticationResolver(e){const t=this.buildRequest();return t.autoCreate=!1,Jp(e,t)}buildRequest(){const e={requestUri:"http://localhost",returnSecureToken:!0};if(this.pendingToken)e.pendingToken=this.pendingToken;else{const t={};this.idToken&&(t.id_token=this.idToken),this.accessToken&&(t.access_token=this.accessToken),this.secret&&(t.oauth_token_secret=this.secret),t.providerId=this.providerId,this.nonce&&!this.pendingToken&&(t.nonce=this.nonce),e.postBody=ne(t)}return e}constructor(){super(...arguments),this.pendingToken=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Zp extends Kp{static _fromVerification(e,t){return new Zp({verificationId:e,verificationCode:t})}static _fromTokenResponse(e,t){return new Zp({phoneNumber:e,temporaryProof:t})}_getIdTokenResponse(e){return async function(e,t){return ep(e,"POST","/v1/accounts:signInWithPhoneNumber",Yf(e,t))}(e,this._makeVerificationRequest())}_linkToIdToken(e,t){return async function(e,t){const n=await ep(e,"POST","/v1/accounts:signInWithPhoneNumber",Yf(e,t));if(n.temporaryProof)throw ip(e,"account-exists-with-different-credential",n);return n}(e,Object.assign({idToken:t},this._makeVerificationRequest()))}_getReauthenticationResolver(e){return async function(e,t){return ep(e,"POST","/v1/accounts:signInWithPhoneNumber",Yf(e,Object.assign(Object.assign({},t),{operation:"REAUTH"})),Xp)}(e,this._makeVerificationRequest())}_makeVerificationRequest(){const{temporaryProof:e,phoneNumber:t,verificationId:n,verificationCode:i}=this.params;return e&&t?{temporaryProof:e,phoneNumber:t}:{sessionInfo:n,code:i}}toJSON(){const e={providerId:this.providerId};return this.params.phoneNumber&&(e.phoneNumber=this.params.phoneNumber),this.params.temporaryProof&&(e.temporaryProof=this.params.temporaryProof),this.params.verificationCode&&(e.verificationCode=this.params.verificationCode),this.params.verificationId&&(e.verificationId=this.params.verificationId),e}static fromJSON(e){"string"==typeof e&&(e=JSON.parse(e));const{verificationId:t,verificationCode:n,phoneNumber:i,temporaryProof:s}=e;return n||t||i||s?new Zp({verificationId:t,verificationCode:n,phoneNumber:i,temporaryProof:s}):null}constructor(e){super("phone","phone"),this.params=e}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class tm{static credential(e,t){return Qp._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=em.parseLink(t);return Vf(n,"argument-error"),Qp._fromEmailAndCode(e,n.code,n.tenantId)}constructor(){this.providerId=tm.PROVIDER_ID}}tm.PROVIDER_ID="password",tm.EMAIL_PASSWORD_SIGN_IN_METHOD="password",tm.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class am extends im{static credential(e,t){return Yp._fromParams({providerId:am.PROVIDER_ID,signInMethod:am.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return am.credentialFromTaggedObject(e)}static credentialFromError(e){return am.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:n}=e;if(!t||!n)return null;try{return am.credential(t,n)}catch(e){return null}}constructor(){super("twitter.com")}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function hm(e,t){return ep(e,"POST","/v1/accounts:signUp",Yf(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Sm.receivers=[];class Cm{removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,n=50){const i="undefined"!=typeof MessageChannel?new MessageChannel:null;if(!i)throw new Error("connection_unavailable");let s,r;return new Promise(((o,a)=>{const h=km("",20);i.port1.start();const c=setTimeout((()=>{a(new Error("unsupported_event"))}),n);r={messageChannel:i,onMessage(e){const t=e;if(t.data.eventId===h)switch(t.data.status){case"ack":clearTimeout(c),s=setTimeout((()=>{a(new Error("timeout"))}),3e3);break;case"done":clearTimeout(s),o(t.data.response);break;default:clearTimeout(c),clearTimeout(s),a(new Error("invalid_response"))}}},this.handlers.add(r),i.port1.addEventListener("message",r.onMessage),this.target.postMessage({eventType:e,eventId:h,data:t},[i.port2])})).finally((()=>{r&&this.removeMessageHandler(r)}))}constructor(e){this.target=e,this.handlers=new Set}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Mp("rcb"),new Kf(3e4,6e4);async function Fm(e,t,n){var i;const s=await n.verify();try{let r;if(Vf("string"==typeof s,e,"argument-error"),Vf("recaptcha"===n.type,e,"argument-error"),r="string"==typeof t?{phoneNumber:t}:t,"session"in r){const t=r.session;if("phoneNumber"in r){Vf("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e,t){return Xf(e,"POST","/v2/accounts/mfaEnrollment:start",Yf(e,t))}(e,{idToken:t.credential,phoneEnrollmentInfo:{phoneNumber:r.phoneNumber,recaptchaToken:s}});return n.phoneSessionInfo.sessionInfo}{Vf("signin"===t.type,e,"internal-error");const n=(null===(i=r.multiFactorHint)||void 0===i?void 0:i.uid)||r.multiFactorUid;Vf(n,e,"missing-multi-factor-info");const o=await function(e,t){return Xf(e,"POST","/v2/accounts/mfaSignIn:start",Yf(e,t))}(e,{mfaPendingCredential:t.credential,mfaEnrollmentId:n,phoneSignInInfo:{recaptchaToken:s}});return o.phoneResponseInfo.sessionInfo}}{const{sessionInfo:t}=await async function(e,t){return Xf(e,"POST","/v1/accounts:sendVerificationCode",Yf(e,t))}(e,{phoneNumber:r.phoneNumber,recaptchaToken:s});return t}}finally{n._reset()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Vm(e,t){return t?mp(t):(Vf(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Um.PROVIDER_ID="phone",Um.PHONE_SIGN_IN_METHOD="phone";class jm extends Kp{_getIdTokenResponse(e){return Jp(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Jp(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Jp(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}constructor(e){super("custom","custom"),this.params=e}}function qm(e){return mm(e.auth,new jm(e),e.bypassAuthState)}function Bm(e){const{auth:t,user:n}=e;return Vf(n,t,"internal-error"),pm(n,new jm(e),e.bypassAuthState)}async function Hm(e){const{auth:t,user:n}=e;return Vf(n,t,"internal-error"),fm(n,new jm(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Wm=new Map;class Gm extends zm{async execute(){let e=Wm.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=Ym(t),i=Jm(e);if(!await i._isAvailable())return!1;const s="true"===await i._get(n);return await i._remove(n),s}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}Wm.set(this.auth._key(),e)}return this.bypassAuthState||Wm.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}}function Qm(e,t){Wm.set(e._key(),t)}function Jm(e){return mp(e._redirectPersistence)}function Ym(e){return wp("pendingRedirect",e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lg=new Kf(5e3,15e3),ug={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},dg=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function fg(e){const t=e.config;Vf(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?Wf(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:"9.22.0"},s=dg.get(e.config.apiHost);s&&(i.eid=s);const r=e._getFrameworks();return r.length&&(i.fw=r.join(",")),`${n}?${ne(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new mg(null);const u=window.open(t||"",a,l);Vf(u,e,"popup-blocked");try{u.focus()}catch(e){}return new mg(u)}const yg=encodeURIComponent("fac");async function wg(e,t,n,i,s,r){Vf(e.config.authDomain,e,"auth-domain-config-required"),Vf(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:"9.22.0",eventId:s};if(t instanceof nm){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",Z(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(r||{}))o[e]=t}if(t instanceof im){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(o.scopes=e.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];const h=await e._getAppCheckToken(),c=h?`#${yg}=${encodeURIComponent(h)}`:"";return`${function({config:e}){return e.emulator?Wf(e,"emulator/auth/handler"):`https://${e.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${ne(a).slice(1)}${c}`}const vg=class{async _openPopup(e,t,n,i){var s;qf(null===(s=this.eventManagers[e._key()])||void 0===s?void 0:s.manager,"_initialize() not called before _openPopup()");return gg(e,await wg(e,t,n,Bf(),i),km())}async _openRedirect(e,t,n,i){await this._originValidation(e);return function(e){Am().location.href=e}(await wg(e,t,n,Bf(),i)),new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(qf(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await cg(e),n=Am().gapi;return Vf(n,e,"internal-error"),t.open({where:document.body,url:fg(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:ug,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const s=Mf(e,"network-request-failed"),r=Am().setTimeout((()=>{i(s)}),lg.get());function o(){Am().clearTimeout(r),n(t)}t.ping(o).then(o,(()=>{i(s)}))}))))}(e),n=new Zm(e);return t.register("authEvent",(t=>{Vf(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const s=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==s&&t(!!s),Pf(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=sg(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Dp()||Tp()||Ap()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Em,this._completeRedirectFn=Xm,this._overrideRedirectResult=Qm}};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const _g=H("authIdTokenMaxAge")||300;let Tg=null;function Ig(e=Ge()){const t=ze(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=ze(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(ee(n.getOptions(),null!=t?t:{}))return e;Pf(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:vg,persistence:[Mm,Tm,Em]}),i=H("authTokenSyncURL");if(i){const e=(s=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>_g)return;const i=null==t?void 0:t.token;Tg!==i&&(Tg=i,await fetch(s,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){he(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){he(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var s;const r=j("auth");return r&&Hp(n,`http://${r}`),n}var Eg;Eg="Browser",He(new ce("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:r,authDomain:o}=n.options;Vf(r&&!r.includes(":"),"invalid-api-key",{appName:n.name});const a={apiKey:r,authDomain:o,clientPlatform:Eg,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Rp(Eg)},h=new jp(n,i,s,a);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(mp);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(h,t),h}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),He(new ce("auth-internal",(e=>{const t=qp(e.getProvider("auth").getImmediate());return new bg(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Qe("@firebase/auth","0.23.2",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Eg)),Qe("@firebase/auth","0.23.2","esm2017");We({apiKey:"AIzaSyCJxy5vpXS7f1dJ93rKe4eeCdNHYRq7lSc",authDomain:"fate-compass-6afb9.firebaseapp.com",projectId:"fate-compass-6afb9",storageBucket:"fate-compass-6afb9.appspot.com",messagingSenderId:"37313764377",appId:"1:37313764377:web:285a6a927584aaec30de88"});const Sg=Od(),kg=Ig(),Cg=Dd(Sg,"reads");let Ag,Ng=[];const Dg={startBtn:document.querySelector(".tarot-button"),tarotRead:document.querySelector(".tarot-cards"),tarotDescr:document.querySelector(".cards-descr")};Dg.startBtn.addEventListener("click",(e=>{Dg.tarotRead.innerHTML="",Dg.tarotDescr.innerHTML="";const t=y();xg(t),Dg.startBtn.style.marginBottom="50px",Rg(t)}));const Rg=e=>{const t=e.map((({pic:e,name:t})=>`<li class="item">\n                <img width="360" src="${e}" alt="${t}"/>\n                <p class="card-name">${t}</p>\n            </li>`)).join("");Dg.tarotRead.insertAdjacentHTML("beforeend",t);const n=e.map((({name:e,meaning_up:t,meaning_rev:n})=>`<li class="item">\n                <h3>${e}</h3>\n                <p><b>Meaning up:</b> ${t}</p>\n                <p><b>Meaning reversed:</b> ${n}</p>\n            </li>`)).join("");Dg.tarotDescr.insertAdjacentHTML("beforeend",n)},xg=e=>{Cf(Cg,{email:Ag,card1:{name:e[0].name,meanUp:e[0].meaning_up,meanRev:e[0].meaning_rev},card2:{name:e[1].name,meanUp:e[1].meaning_up,meanRev:e[1].meaning_rev},card3:{name:e[2].name,meanUp:e[2].meaning_up,meanRev:e[2].meaning_rev},card4:{name:e[3].name,meanUp:e[3].meaning_up,meanRev:e[3].meaning_rev},card5:{name:e[4].name,meanUp:e[4].meaning_up,meanRev:e[4].meaning_rev},card6:{name:e[5].name,meanUp:e[5].meaning_up,meanRev:e[5].meaning_rev}})};vm(kg,(e=>{if(null===e)return;Ag=e.email;kf(lf(Cg,df("email","==",Ag))).then((e=>{e.docs.forEach((e=>{Ng.push({...e.data()})})),console.log(Ng)})),Ng=[]}));We({apiKey:"AIzaSyCJxy5vpXS7f1dJ93rKe4eeCdNHYRq7lSc",authDomain:"fate-compass-6afb9.firebaseapp.com",projectId:"fate-compass-6afb9",storageBucket:"fate-compass-6afb9.appspot.com",messagingSenderId:"37313764377",appId:"1:37313764377:web:285a6a927584aaec30de88"});const Og=Od(),Lg=Ig(),Pg=Dd(Og,"users");let Mg=[],Fg=!1;const Ug={signInForm:document.querySelector(".signin-form"),logInForm:document.querySelector(".login-form"),logOut:document.querySelector(".logout"),logOutBtn:document.querySelector(".logout-btn"),tarotRead:document.querySelector(".tarot-read"),matrixRead:document.querySelector(".matrix-read"),logIn:document.querySelector(".login"),signIn:document.querySelector(".signin"),haveAccount:document.querySelector(".have-account"),profileBtn:document.querySelector(".profile-btn"),backdrop:document.querySelector(".backdrop"),closeBtn:document.querySelector("[data-close]")},{signInForm:Vg,logInForm:jg,logOut:qg,logOutBtn:Bg,tarotRead:Hg,matrixRead:zg,logIn:$g,signIn:Kg,haveAccount:Wg,profileBtn:Gg,backdrop:Qg,closeBtn:Jg}=Ug;Vg.addEventListener("submit",(e=>{e.preventDefault();const t=Vg.email.value,n=Vg.password.value,i=Math.random()>=.5;if(n!==Kg.passwordMatch.value)return Kg.reset();ym(Lg,t,n).then((e=>{console.log(`Welcome to the gay club, ${e.user.email}`),Cf(Pg,{email:t.toLowerCase(),password:n,vipAccount:i}).then((()=>{Vg.reset()}))})).catch((e=>console.log(e.message)))})),jg.addEventListener("submit",(e=>{e.preventDefault();const t=jg.email.value,n=jg.password.value;wm(Lg,t,n).then((e=>{console.log("Welcome back",e.user.email);kf(lf(Pg,df("email","==",e.user.email))).then((e=>{e.docs.forEach((e=>{Mg.push({...e.data()})})),localStorage.setItem("isVip",JSON.stringify(Mg[0].vipAccount))})),Mg=[],jg.reset()})).catch((e=>{console.log(e.message)})),console.log("signed in")})),Bg.addEventListener("click",(()=>{var e;(e=Lg,he(e).signOut()).then((()=>{console.log("signed out")})).catch((e=>{console.log(e.message)}))})),vm(Lg,(e=>{null===e&&localStorage.removeItem("isVip");const t=document.querySelector("[data-user]");if(null===e)t.textContent="",qg.classList.add("hidden"),$g.classList.remove("hidden");else{t.textContent=`Welcome ${e.email}`,qg.classList.remove("hidden"),$g.classList.add("hidden"),Kg.classList.add("hidden"),Wg.classList.add("hidden");setTimeout((()=>{Fg=localStorage.getItem("isVip"),Fg&&(zg.classList.remove("hidden"),Hg.classList.remove("hidden"))}),1e3)}})),Wg.addEventListener("click",(()=>{$g.classList.toggle("hidden"),Kg.classList.toggle("hidden")})),Gg.addEventListener("click",(()=>{Qg.classList.remove("hidden")})),Jg.addEventListener("click",(()=>{Qg.classList.add("hidden")}));
//# sourceMappingURL=index.c1a956e2.js.map
