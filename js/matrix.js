...
const soulShit = mod(centerDay + center);
const soulShit2 = mod(centerMonth + center);

matrixData.push(day, month, year, bottom, center,
...
// Adding shit to the main page
const markup = matrixData.map(n => 
